...
var format_Sitesauxabords_145 = new ol.format.GeoJSON();
var features_Sitesauxabords_145 = format_Sitesauxabords_145.readFeatures(json_Sitesauxabords_145, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Sitesauxabords_145 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Sitesauxabords_145.addFeatures(features_Sitesauxabords_145);
var lyr_Sitesauxabords_145 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Sitesauxabords_145, 
                style: style_Sitesauxabords_145,
                popuplayertitle: 'Sites aux abords',
                interactive: true,
                title: '<img src="styles/legend/Sitesauxabords_145.png" /> Sites aux abords'
            });
var format_SUPMH_146 = new ol.format.GeoJSON();
var features_SUPMH_146 = format_SUPMH_146.readFeatures(json_SUPMH_146, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SUPMH_146 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SUPMH_146.addFeatures(features_SUPMH_146);
var lyr_SUPMH_146 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SUPMH_146, 
                style: style_SUPMH_146,
                popuplayertitle: 'SUPMH',
                interactive: true,
                title: '<img src="styles/legend/SUPMH_146.png" /> SUPMH'
            });
var format_SPR_147 = new ol.format.GeoJSON();
var features_SPR_147 = format_SPR_147.readFeatures(json_SPR_147, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SPR_147 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SPR_147.addFeatures(features_SPR_147);
var lyr_SPR_147 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SPR_147, 
                style: style_SPR_147,
                popuplayertitle: 'SPR',
                interactive: true,
                title: '<img src="styles/legend/SPR_147.png" /> SPR'
            });
var format_Sitesclasss_148 = new ol.format.GeoJSON();
var features_Sitesclasss_148 = format_Sitesclasss_148.readFeatures(json_Sitesclasss_148, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Sitesclasss_148 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Sitesclasss_148.addFeatures(features_Sitesclasss_148);
var lyr_Sitesclasss_148 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Sitesclasss_148, 
                style: style_Sitesclasss_148,
                popuplayertitle: 'Sites classés',
                interactive: true,
                title: '<img src="styles/legend/Sitesclasss_148.png" /> Sites classés'
            });
var format_Sitesinscrits_149 = new ol.format.GeoJSON();
var features_Sitesinscrits_149 = format_Sitesinscrits_149.readFeatures(json_Sitesinscrits_149, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Sitesinscrits_149 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Sitesinscrits_149.addFeatures(features_Sitesinscrits_149);
var lyr_Sitesinscrits_149 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Sitesinscrits_149, 
                style: style_Sitesinscrits_149,
                popuplayertitle: 'Sites inscrits',
                interactive: true,
                title: '<img src="styles/legend/Sitesinscrits_149.png" /> Sites inscrits'
            });
var format_Immeubles_150 = new ol.format.GeoJSON();
var features_Immeubles_150 = format_Immeubles_150.readFeatures(json_Immeubles_150, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Immeubles_150 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Immeubles_150.addFeatures(features_Immeubles_150);
var lyr_Immeubles_150 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Immeubles_150, 
                style: style_Immeubles_150,
                popuplayertitle: 'Immeubles',
                interactive: true,
    title: 'Immeubles<br />\
    <img src="styles/legend/Immeubles_150_0.png" /> Classé<br />\
    <img src="styles/legend/Immeubles_150_1.png" /> Inscrit<br />\
    <img src="styles/legend/Immeubles_150_2.png" /> Non protégé<br />\
    <img src="styles/legend/Immeubles_150_3.png" /> Partiellement Classé<br />\
    <img src="styles/legend/Immeubles_150_4.png" /> Partiellement Classé-Inscrit<br />\
    <img src="styles/legend/Immeubles_150_5.png" /> Partiellement inscrit<br />' });
var format_ZPPA_151 = new ol.format.GeoJSON();
var features_ZPPA_151 = format_ZPPA_151.readFeatures(json_ZPPA_151, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ZPPA_151 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ZPPA_151.addFeatures(features_ZPPA_151);
var lyr_ZPPA_151 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ZPPA_151, 
                style: style_ZPPA_151,
                popuplayertitle: 'ZPPA',
                interactive: true,
                title: '<img src="styles/legend/ZPPA_151.png" /> ZPPA'
            });
var format_ZPPAcentrodes_152 = new ol.format.GeoJSON();
var features_ZPPAcentrodes_152 = format_ZPPAcentrodes_152.readFeatures(json_ZPPAcentrodes_152, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ZPPAcentrodes_152 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ZPPAcentrodes_152.addFeatures(features_ZPPAcentrodes_152);
var lyr_ZPPAcentrodes_152 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ZPPAcentrodes_152, 
                style: style_ZPPAcentrodes_152,
                popuplayertitle: 'ZPPA (centroïdes)',
                interactive: true,
                title: '<img src="styles/legend/ZPPAcentrodes_152.png" /> ZPPA (centroïdes)'
            });
var format_RoutesconcdesTypeC_153 = new ol.format.GeoJSON();
var features_RoutesconcdesTypeC_153 = format_RoutesconcdesTypeC_153.readFeatures(json_RoutesconcdesTypeC_153, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RoutesconcdesTypeC_153 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RoutesconcdesTypeC_153.addFeatures(features_RoutesconcdesTypeC_153);
var lyr_RoutesconcdesTypeC_153 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RoutesconcdesTypeC_153, 
                style: style_RoutesconcdesTypeC_153,
                popuplayertitle: 'Routes concédées - Type C',
                interactive: true,
    title: 'Routes concédées - Type C<br />\
    <img src="styles/legend/RoutesconcdesTypeC_153_0.png" /> Dépasssement du seuil réglementaire LDEN = 68 dB(A)<br />' });
var format_RoutesconcdesTypeA_154 = new ol.format.GeoJSON();
var features_RoutesconcdesTypeA_154 = format_RoutesconcdesTypeA_154.readFeatures(json_RoutesconcdesTypeA_154, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RoutesconcdesTypeA_154 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RoutesconcdesTypeA_154.addFeatures(features_RoutesconcdesTypeA_154);
var lyr_RoutesconcdesTypeA_154 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RoutesconcdesTypeA_154, 
                style: style_RoutesconcdesTypeA_154,
                popuplayertitle: 'Routes concédées - Type A',
                interactive: true,
    title: 'Routes concédées - Type A<br />\
    <img src="styles/legend/RoutesconcdesTypeA_154_0.png" /> 55 à 60 dB(A)<br />\
    <img src="styles/legend/RoutesconcdesTypeA_154_1.png" /> 60 à 65 dB(A)<br />\
    <img src="styles/legend/RoutesconcdesTypeA_154_2.png" /> 65 à 70 dB(A)<br />\
    <img src="styles/legend/RoutesconcdesTypeA_154_3.png" /> 70 à 75 dB(A)<br />\
    <img src="styles/legend/RoutesconcdesTypeA_154_4.png" /> > 75  dB(A)<br />' });
var format_RoutesTypeC_155 = new ol.format.GeoJSON();
var features_RoutesTypeC_155 = format_RoutesTypeC_155.readFeatures(json_RoutesTypeC_155, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RoutesTypeC_155 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RoutesTypeC_155.addFeatures(features_RoutesTypeC_155);
var lyr_RoutesTypeC_155 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RoutesTypeC_155, 
                style: style_RoutesTypeC_155,
                popuplayertitle: 'Routes - Type C',
                interactive: true,
    title: 'Routes - Type C<br />\
    <img src="styles/legend/RoutesTypeC_155_0.png" /> >68<br />\
    <img src="styles/legend/RoutesTypeC_155_1.png" /> >73<br />' });
var format_RoutesTypeA_156 = new ol.format.GeoJSON();
var features_RoutesTypeA_156 = format_RoutesTypeA_156.readFeatures(json_RoutesTypeA_156, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RoutesTypeA_156 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RoutesTypeA_156.addFeatures(features_RoutesTypeA_156);
var lyr_RoutesTypeA_156 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RoutesTypeA_156, 
                style: style_RoutesTypeA_156,
                popuplayertitle: 'Routes - Type A',
                interactive: true,
    title: 'Routes - Type A<br />\
    <img src="styles/legend/RoutesTypeA_156_0.png" /> 55-60<br />\
    <img src="styles/legend/RoutesTypeA_156_1.png" /> 60-65<br />\
    <img src="styles/legend/RoutesTypeA_156_2.png" /> 65-70<br />\
    <img src="styles/legend/RoutesTypeA_156_3.png" /> 70-75<br />\
    <img src="styles/legend/RoutesTypeA_156_4.png" /> >75<br />' });
var format_Canalisationshydrocarbures_157 = new ol.format.GeoJSON();
var features_Canalisationshydrocarbures_157 = format_Canalisationshydrocarbures_157.readFeatures(json_Canalisationshydrocarbures_157, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Canalisationshydrocarbures_157 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Canalisationshydrocarbures_157.addFeatures(features_Canalisationshydrocarbures_157);
var lyr_Canalisationshydrocarbures_157 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Canalisationshydrocarbures_157, 
                style: style_Canalisationshydrocarbures_157,
                popuplayertitle: 'Canalisations hydrocarbures',
                interactive: true,
                title: '<img src="styles/legend/Canalisationshydrocarbures_157.png" /> Canalisations hydrocarbures'
            });
var format_CanalisationsgazGRT_158 = new ol.format.GeoJSON();
var features_CanalisationsgazGRT_158 = format_CanalisationsgazGRT_158.readFeatures(json_CanalisationsgazGRT_158, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CanalisationsgazGRT_158 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CanalisationsgazGRT_158.addFeatures(features_CanalisationsgazGRT_158);
var lyr_CanalisationsgazGRT_158 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CanalisationsgazGRT_158, 
                style: style_CanalisationsgazGRT_158,
                popuplayertitle: 'Canalisations gaz GRT',
                interactive: true,
                title: '<img src="styles/legend/CanalisationsgazGRT_158.png" /> Canalisations gaz GRT'
            });
var format_CanalisationsgazGRDF_159 = new ol.format.GeoJSON();
var features_CanalisationsgazGRDF_159 = format_CanalisationsgazGRDF_159.readFeatures(json_CanalisationsgazGRDF_159, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CanalisationsgazGRDF_159 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CanalisationsgazGRDF_159.addFeatures(features_CanalisationsgazGRDF_159);
var lyr_CanalisationsgazGRDF_159 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CanalisationsgazGRDF_159, 
                style: style_CanalisationsgazGRDF_159,
                popuplayertitle: 'Canalisations gaz GRDF',
                interactive: true,
                title: '<img src="styles/legend/CanalisationsgazGRDF_159.png" /> Canalisations gaz GRDF'
            });
var format_LignesbassetensionsouterrainesENEDIS_160 = new ol.format.GeoJSON();
var features_LignesbassetensionsouterrainesENEDIS_160 = format_LignesbassetensionsouterrainesENEDIS_160.readFeatures(json_LignesbassetensionsouterrainesENEDIS_160, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LignesbassetensionsouterrainesENEDIS_160 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LignesbassetensionsouterrainesENEDIS_160.addFeatures(features_LignesbassetensionsouterrainesENEDIS_160);
var lyr_LignesbassetensionsouterrainesENEDIS_160 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LignesbassetensionsouterrainesENEDIS_160, 
                style: style_LignesbassetensionsouterrainesENEDIS_160,
                popuplayertitle: 'Lignes basse tension souterraines ENEDIS',
                interactive: true,
                title: '<img src="styles/legend/LignesbassetensionsouterrainesENEDIS_160.png" /> Lignes basse tension souterraines ENEDIS'
            });
var format_LignesbassetensionariennesENEDIS_161 = new ol.format.GeoJSON();
var features_LignesbassetensionariennesENEDIS_161 = format_LignesbassetensionariennesENEDIS_161.readFeatures(json_LignesbassetensionariennesENEDIS_161, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LignesbassetensionariennesENEDIS_161 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LignesbassetensionariennesENEDIS_161.addFeatures(features_LignesbassetensionariennesENEDIS_161);
var lyr_LignesbassetensionariennesENEDIS_161 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LignesbassetensionariennesENEDIS_161, 
                style: style_LignesbassetensionariennesENEDIS_161,
                popuplayertitle: 'Lignes basse tension aériennes ENEDIS',
                interactive: true,
                title: '<img src="styles/legend/LignesbassetensionariennesENEDIS_161.png" /> Lignes basse tension aériennes ENEDIS'
            });
var format_LigneshautetensionsouterrainesENEDIS_162 = new ol.format.GeoJSON();
var features_LigneshautetensionsouterrainesENEDIS_162 = format_LigneshautetensionsouterrainesENEDIS_162.readFeatures(json_LigneshautetensionsouterrainesENEDIS_162, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LigneshautetensionsouterrainesENEDIS_162 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LigneshautetensionsouterrainesENEDIS_162.addFeatures(features_LigneshautetensionsouterrainesENEDIS_162);
var lyr_LigneshautetensionsouterrainesENEDIS_162 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LigneshautetensionsouterrainesENEDIS_162, 
                style: style_LigneshautetensionsouterrainesENEDIS_162,
                popuplayertitle: 'Lignes haute tension souterraines ENEDIS',
                interactive: true,
                title: '<img src="styles/legend/LigneshautetensionsouterrainesENEDIS_162.png" /> Lignes haute tension souterraines ENEDIS'
            });
var format_LigneshautetensionariennesENEDIS_163 = new ol.format.GeoJSON();
var features_LigneshautetensionariennesENEDIS_163 = format_LigneshautetensionariennesENEDIS_163.readFeatures(json_LigneshautetensionariennesENEDIS_163, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LigneshautetensionariennesENEDIS_163 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LigneshautetensionariennesENEDIS_163.addFeatures(features_LigneshautetensionariennesENEDIS_163);
var lyr_LigneshautetensionariennesENEDIS_163 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LigneshautetensionariennesENEDIS_163, 
                style: style_LigneshautetensionariennesENEDIS_163,
                popuplayertitle: 'Lignes haute tension aériennes ENEDIS',
                interactive: true,
                title: '<img src="styles/legend/LigneshautetensionariennesENEDIS_163.png" /> Lignes haute tension aériennes ENEDIS'
            });
var format_LigneshautetensionRTE_164 = new ol.format.GeoJSON();
var features_LigneshautetensionRTE_164 = format_LigneshautetensionRTE_164.readFeatures(json_LigneshautetensionRTE_164, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LigneshautetensionRTE_164 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LigneshautetensionRTE_164.addFeatures(features_LigneshautetensionRTE_164);
var lyr_LigneshautetensionRTE_164 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LigneshautetensionRTE_164, 
                style: style_LigneshautetensionRTE_164,
                popuplayertitle: 'Lignes haute tension RTE',
                interactive: true,
                title: '<img src="styles/legend/LigneshautetensionRTE_164.png" /> Lignes haute tension RTE'
            });
var format_Postesdetransformation_165 = new ol.format.GeoJSON();
var features_Postesdetransformation_165 = format_Postesdetransformation_165.readFeatures(json_Postesdetransformation_165, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Postesdetransformation_165 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Postesdetransformation_165.addFeatures(features_Postesdetransformation_165);
var lyr_Postesdetransformation_165 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Postesdetransformation_165, 
                style: style_Postesdetransformation_165,
                popuplayertitle: 'Postes de transformation',
                interactive: true,
                title: '<img src="styles/legend/Postesdetransformation_165.png" /> Postes de transformation'
            });
var format_Itinraireautre_166 = new ol.format.GeoJSON();
var features_Itinraireautre_166 = format_Itinraireautre_166.readFeatures(json_Itinraireautre_166, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Itinraireautre_166 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Itinraireautre_166.addFeatures(features_Itinraireautre_166);
var lyr_Itinraireautre_166 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Itinraireautre_166, 
                style: style_Itinraireautre_166,
                popuplayertitle: 'Itinéraire autre',
                interactive: true,
                title: '<img src="styles/legend/Itinraireautre_166.png" /> Itinéraire autre'
            });
var format_Voieferre_167 = new ol.format.GeoJSON();
var features_Voieferre_167 = format_Voieferre_167.readFeatures(json_Voieferre_167, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Voieferre_167 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Voieferre_167.addFeatures(features_Voieferre_167);
var lyr_Voieferre_167 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Voieferre_167, 
                style: style_Voieferre_167,
                popuplayertitle: 'Voie ferrée',
                interactive: true,
                title: '<img src="styles/legend/Voieferre_167.png" /> Voie ferrée'
            });
var format_RoutesdeGrandeCirculation_168 = new ol.format.GeoJSON();
var features_RoutesdeGrandeCirculation_168 = format_RoutesdeGrandeCirculation_168.readFeatures(json_RoutesdeGrandeCirculation_168, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RoutesdeGrandeCirculation_168 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RoutesdeGrandeCirculation_168.addFeatures(features_RoutesdeGrandeCirculation_168);
var lyr_RoutesdeGrandeCirculation_168 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RoutesdeGrandeCirculation_168, 
                style: style_RoutesdeGrandeCirculation_168,
                popuplayertitle: 'Routes de Grande Circulation',
                interactive: true,
                title: '<img src="styles/legend/RoutesdeGrandeCirculation_168.png" /> Routes de Grande Circulation'
            });
var format_Routesnumrotesounommes_169 = new ol.format.GeoJSON();
var features_Routesnumrotesounommes_169 = format_Routesnumrotesounommes_169.readFeatures(json_Routesnumrotesounommes_169, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Routesnumrotesounommes_169 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Routesnumrotesounommes_169.addFeatures(features_Routesnumrotesounommes_169);
var lyr_Routesnumrotesounommes_169 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Routesnumrotesounommes_169, 
                style: style_Routesnumrotesounommes_169,
                popuplayertitle: 'Routes numérotées ou nommées',
                interactive: true,
    title: 'Routes numérotées ou nommées<br />\
    <img src="styles/legend/Routesnumrotesounommes_169_0.png" /> Autoroute<br />\
    <img src="styles/legend/Routesnumrotesounommes_169_1.png" /> Nationale<br />\
    <img src="styles/legend/Routesnumrotesounommes_169_2.png" /> Départementale<br />\
    <img src="styles/legend/Routesnumrotesounommes_169_3.png" /> Route nommée<br />\
    <img src="styles/legend/Routesnumrotesounommes_169_4.png" /> Voie verte<br />' });
var format_Niveaudurisque_170 = new ol.format.GeoJSON();
var features_Niveaudurisque_170 = format_Niveaudurisque_170.readFeatures(json_Niveaudurisque_170, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Niveaudurisque_170 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Niveaudurisque_170.addFeatures(features_Niveaudurisque_170);
var lyr_Niveaudurisque_170 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Niveaudurisque_170, 
                style: style_Niveaudurisque_170,
                popuplayertitle: 'Niveau du risque',
                interactive: true,
    title: 'Niveau du risque<br />\
    <img src="styles/legend/Niveaudurisque_170_0.png" /> Faible<br />\
    <img src="styles/legend/Niveaudurisque_170_1.png" /> Moyen<br />\
    <img src="styles/legend/Niveaudurisque_170_2.png" /> Fort<br />' });
var format_Zonesdalas_171 = new ol.format.GeoJSON();
var features_Zonesdalas_171 = format_Zonesdalas_171.readFeatures(json_Zonesdalas_171, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Zonesdalas_171 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Zonesdalas_171.addFeatures(features_Zonesdalas_171);
var lyr_Zonesdalas_171 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Zonesdalas_171, 
                style: style_Zonesdalas_171,
                popuplayertitle: 'Zones d\'aléas',
                interactive: true,
    title: 'Zones d\'aléas<br />\
    <img src="styles/legend/Zonesdalas_171_0.png" /> Faible<br />\
    <img src="styles/legend/Zonesdalas_171_1.png" /> Moyen<br />\
    <img src="styles/legend/Zonesdalas_171_2.png" /> Fort<br />\
    <img src="styles/legend/Zonesdalas_171_3.png" /> Vigilance<br />\
    <img src="styles/legend/Zonesdalas_171_4.png" /> Nappe<br />' });
var format_Zonesrglementaires_172 = new ol.format.GeoJSON();
var features_Zonesrglementaires_172 = format_Zonesrglementaires_172.readFeatures(json_Zonesrglementaires_172, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Zonesrglementaires_172 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Zonesrglementaires_172.addFeatures(features_Zonesrglementaires_172);
var lyr_Zonesrglementaires_172 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Zonesrglementaires_172, 
                style: style_Zonesrglementaires_172,
                popuplayertitle: 'Zones réglementaires',
                interactive: true,
    title: 'Zones réglementaires<br />\
    <img src="styles/legend/Zonesrglementaires_172_0.png" /> Bleu clair<br />\
    <img src="styles/legend/Zonesrglementaires_172_1.png" /> Rouge<br />\
    <img src="styles/legend/Zonesrglementaires_172_2.png" /> Violet<br />' });
var format_Ruissellement_173 = new ol.format.GeoJSON();
var features_Ruissellement_173 = format_Ruissellement_173.readFeatures(json_Ruissellement_173, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ruissellement_173 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ruissellement_173.addFeatures(features_Ruissellement_173);
var lyr_Ruissellement_173 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ruissellement_173, 
                style: style_Ruissellement_173,
                popuplayertitle: 'Ruissellement',
                interactive: true,
                title: '<img src="styles/legend/Ruissellement_173.png" /> Ruissellement'
            });
var format_Secteurs_174 = new ol.format.GeoJSON();
var features_Secteurs_174 = format_Secteurs_174.readFeatures(json_Secteurs_174, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Secteurs_174 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Secteurs_174.addFeatures(features_Secteurs_174);
var lyr_Secteurs_174 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Secteurs_174, 
                style: style_Secteurs_174,
                popuplayertitle: 'Secteurs',
                interactive: true,
    title: 'Secteurs<br />\
    <img src="styles/legend/Secteurs_174_0.png" /> 1<br />\
    <img src="styles/legend/Secteurs_174_1.png" /> 2<br />\
    <img src="styles/legend/Secteurs_174_2.png" /> 3<br />\
    <img src="styles/legend/Secteurs_174_3.png" /> 4<br />' });
var format_ICPE_175 = new ol.format.GeoJSON();
var features_ICPE_175 = format_ICPE_175.readFeatures(json_ICPE_175, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ICPE_175 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ICPE_175.addFeatures(features_ICPE_175);
var lyr_ICPE_175 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ICPE_175, 
                style: style_ICPE_175,
                popuplayertitle: 'ICPE',
                interactive: true,
    title: 'ICPE<br />\
    <img src="styles/legend/ICPE_175_0.png" /> Activités des sièges sociaux ; conseil de gestion<br />\
    <img src="styles/legend/ICPE_175_1.png" /> Collecte des déchets/traitements des eaux usées<br />\
    <img src="styles/legend/ICPE_175_2.png" /> Commerce<br />\
    <img src="styles/legend/ICPE_175_3.png" /> Culture et production animale, chasse et services annexes<br />\
    <img src="styles/legend/ICPE_175_4.png" /> Dépollution et autres services de gestion des déchets<br />\
    <img src="styles/legend/ICPE_175_5.png" /> Fabrications/manufactures <br />\
    <img src="styles/legend/ICPE_175_6.png" /> Génie civil<br />\
    <img src="styles/legend/ICPE_175_7.png" /> Industries<br />\
    <img src="styles/legend/ICPE_175_8.png" /> Production et distribution d\'électricité, de gaz, de vapeur et d\'air conditionné<br />\
    <img src="styles/legend/ICPE_175_9.png" /> Entreprises de travaux/constructions<br />' });
var format_SitesBASOL_176 = new ol.format.GeoJSON();
var features_SitesBASOL_176 = format_SitesBASOL_176.readFeatures(json_SitesBASOL_176, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SitesBASOL_176 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SitesBASOL_176.addFeatures(features_SitesBASOL_176);
var lyr_SitesBASOL_176 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SitesBASOL_176, 
                style: style_SitesBASOL_176,
                popuplayertitle: 'Sites BASOL',
                interactive: true,
                title: '<img src="styles/legend/SitesBASOL_176.png" /> Sites BASOL'
            });
var format_Sitespollus_177 = new ol.format.GeoJSON();
var features_Sitespollus_177 = format_Sitespollus_177.readFeatures(json_Sitespollus_177, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Sitespollus_177 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Sitespollus_177.addFeatures(features_Sitespollus_177);
var lyr_Sitespollus_177 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Sitespollus_177, 
                style: style_Sitespollus_177,
                popuplayertitle: 'Sites pollués',
                interactive: true,
                title: '<img src="styles/legend/Sitespollus_177.png" /> Sites pollués'
            });
var format_Zonesimpermables_178 = new ol.format.GeoJSON();
var features_Zonesimpermables_178 = format_Zonesimpermables_178.readFeatures(json_Zonesimpermables_178, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Zonesimpermables_178 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Zonesimpermables_178.addFeatures(features_Zonesimpermables_178);
var lyr_Zonesimpermables_178 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Zonesimpermables_178, 
                style: style_Zonesimpermables_178,
                popuplayertitle: 'Zones imperméables',
                interactive: true,
                title: '<img src="styles/legend/Zonesimpermables_178.png" /> Zones imperméables'
            });
var format_Remontesdenappes_179 = new ol.format.GeoJSON();
var features_Remontesdenappes_179 = format_Remontesdenappes_179.readFeatures(json_Remontesdenappes_179, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Remontesdenappes_179 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Remontesdenappes_179.addFeatures(features_Remontesdenappes_179);
var lyr_Remontesdenappes_179 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Remontesdenappes_179, 
                style: style_Remontesdenappes_179,
                popuplayertitle: 'Remontées de nappes',
                interactive: true,
    title: 'Remontées de nappes<br />\
    <img src="styles/legend/Remontesdenappes_179_0.png" /> Zones potentiellement sujettes aux débordements de nappe<br />\
    <img src="styles/legend/Remontesdenappes_179_1.png" /> Zones potentiellement sujettes aux inondations de cave<br />' });
var format_ZNIEFFtype2_180 = new ol.format.GeoJSON();
var features_ZNIEFFtype2_180 = format_ZNIEFFtype2_180.readFeatures(json_ZNIEFFtype2_180, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ZNIEFFtype2_180 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ZNIEFFtype2_180.addFeatures(features_ZNIEFFtype2_180);
var lyr_ZNIEFFtype2_180 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ZNIEFFtype2_180, 
                style: style_ZNIEFFtype2_180,
                popuplayertitle: 'ZNIEFF type 2',
                interactive: true,
                title: '<img src="styles/legend/ZNIEFFtype2_180.png" /> ZNIEFF type 2'
            });
var format_ZNIEFFtype1_181 = new ol.format.GeoJSON();
var features_ZNIEFFtype1_181 = format_ZNIEFFtype1_181.readFeatures(json_ZNIEFFtype1_181, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ZNIEFFtype1_181 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ZNIEFFtype1_181.addFeatures(features_ZNIEFFtype1_181);
var lyr_ZNIEFFtype1_181 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ZNIEFFtype1_181, 
                style: style_ZNIEFFtype1_181,
                popuplayertitle: 'ZNIEFF type 1',
                interactive: true,
                title: '<img src="styles/legend/ZNIEFFtype1_181.png" /> ZNIEFF type 1'
            });
var format_Zoneshumides_182 = new ol.format.GeoJSON();
var features_Zoneshumides_182 = format_Zoneshumides_182.readFeatures(json_Zoneshumides_182, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Zoneshumides_182 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Zoneshumides_182.addFeatures(features_Zoneshumides_182);
var lyr_Zoneshumides_182 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Zoneshumides_182, 
                style: style_Zoneshumides_182,
                popuplayertitle: 'Zones humides',
                interactive: true,
                title: '<img src="styles/legend/Zoneshumides_182.png" /> Zones humides'
            });
var format_Natura2000_183 = new ol.format.GeoJSON();
var features_Natura2000_183 = format_Natura2000_183.readFeatures(json_Natura2000_183, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Natura2000_183 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Natura2000_183.addFeatures(features_Natura2000_183);
var lyr_Natura2000_183 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Natura2000_183, 
                style: style_Natura2000_183,
                popuplayertitle: 'Natura 2000',
                interactive: true,
                title: '<img src="styles/legend/Natura2000_183.png" /> Natura 2000'
            });
var format_Cimetire_184 = new ol.format.GeoJSON();
var features_Cimetire_184 = format_Cimetire_184.readFeatures(json_Cimetire_184, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Cimetire_184 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Cimetire_184.addFeatures(features_Cimetire_184);
var lyr_Cimetire_184 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Cimetire_184,
maxResolution:7.00111653806549,
 
                style: style_Cimetire_184,
                popuplayertitle: 'Cimetière',
                interactive: true,
                title: '<img src="styles/legend/Cimetire_184.png" /> Cimetière'
            });
var format_Rservoir_185 = new ol.format.GeoJSON();
var features_Rservoir_185 = format_Rservoir_185.readFeatures(json_Rservoir_185, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Rservoir_185 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Rservoir_185.addFeatures(features_Rservoir_185);
var lyr_Rservoir_185 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Rservoir_185,
maxResolution:7.00111653806549,
 
                style: style_Rservoir_185,
                popuplayertitle: 'Réservoir',
                interactive: true,
                title: '<img src="styles/legend/Rservoir_185.png" /> Réservoir'
            });
var format_Terraindesport_186 = new ol.format.GeoJSON();
var features_Terraindesport_186 = format_Terraindesport_186.readFeatures(json_Terraindesport_186, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Terraindesport_186 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Terraindesport_186.addFeatures(features_Terraindesport_186);
var lyr_Terraindesport_186 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Terraindesport_186,
maxResolution:7.00111653806549,
 
                style: style_Terraindesport_186,
                popuplayertitle: 'Terrain de sport',
                interactive: true,
                title: '<img src="styles/legend/Terraindesport_186.png" /> Terrain de sport'
            });
var format_Monument_187 = new ol.format.GeoJSON();
var features_Monument_187 = format_Monument_187.readFeatures(json_Monument_187, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Monument_187 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Monument_187.addFeatures(features_Monument_187);
var lyr_Monument_187 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Monument_187,
maxResolution:7.00111653806549,
 
                style: style_Monument_187,
                popuplayertitle: 'Monument',
                interactive: true,
                title: '<img src="styles/legend/Monument_187.png" /> Monument'
            });
var format_Indiffrenci_188 = new ol.format.GeoJSON();
var features_Indiffrenci_188 = format_Indiffrenci_188.readFeatures(json_Indiffrenci_188, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Indiffrenci_188 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Indiffrenci_188.addFeatures(features_Indiffrenci_188);
var lyr_Indiffrenci_188 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Indiffrenci_188,
maxResolution:7.00111653806549,
 
                style: style_Indiffrenci_188,
                popuplayertitle: 'Indifférencié',
                interactive: true,
                title: '<img src="styles/legend/Indiffrenci_188.png" /> Indifférencié'
            });
var format_Industrielagricoleoucommercial_189 = new ol.format.GeoJSON();
var features_Industrielagricoleoucommercial_189 = format_Industrielagricoleoucommercial_189.readFeatures(json_Industrielagricoleoucommercial_189, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Industrielagricoleoucommercial_189 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Industrielagricoleoucommercial_189.addFeatures(features_Industrielagricoleoucommercial_189);
var lyr_Industrielagricoleoucommercial_189 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Industrielagricoleoucommercial_189,
maxResolution:7.00111653806549,
 
                style: style_Industrielagricoleoucommercial_189,
                popuplayertitle: 'Industriel, agricole ou commercial',
                interactive: true,
                title: '<img src="styles/legend/Industrielagricoleoucommercial_189.png" /> Industriel, agricole ou commercial'
            });
var format_Constructionsponctuelles_190 = new ol.format.GeoJSON();
var features_Constructionsponctuelles_190 = format_Constructionsponctuelles_190.readFeatures(json_Constructionsponctuelles_190, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Constructionsponctuelles_190 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Constructionsponctuelles_190.addFeatures(features_Constructionsponctuelles_190);
var lyr_Constructionsponctuelles_190 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Constructionsponctuelles_190,
maxResolution:7.00111653806549,
 
                style: style_Constructionsponctuelles_190,
                popuplayertitle: 'Constructions ponctuelles',
                interactive: true,
                title: '<img src="styles/legend/Constructionsponctuelles_190.png" /> Constructions ponctuelles'
            });
var format_Pylne_191 = new ol.format.GeoJSON();
var features_Pylne_191 = format_Pylne_191.readFeatures(json_Pylne_191, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Pylne_191 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Pylne_191.addFeatures(features_Pylne_191);
var lyr_Pylne_191 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Pylne_191, 
                style: style_Pylne_191,
                popuplayertitle: 'Pylône',
                interactive: true,
                title: '<img src="styles/legend/Pylne_191.png" /> Pylône'
            });
var format_CCdes4Rivires_192 = new ol.format.GeoJSON();
var features_CCdes4Rivires_192 = format_CCdes4Rivires_192.readFeatures(json_CCdes4Rivires_192, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CCdes4Rivires_192 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CCdes4Rivires_192.addFeatures(features_CCdes4Rivires_192);
var lyr_CCdes4Rivires_192 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CCdes4Rivires_192, 
                style: style_CCdes4Rivires_192,
                popuplayertitle: 'CC des 4 Rivières',
                interactive: true,
                title: '<img src="styles/legend/CCdes4Rivires_192.png" /> CC des 4 Rivières'
            });
var format_CCBrayEawy_193 = new ol.format.GeoJSON();
var features_CCBrayEawy_193 = format_CCBrayEawy_193.readFeatures(json_CCBrayEawy_193, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CCBrayEawy_193 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CCBrayEawy_193.addFeatures(features_CCBrayEawy_193);
var lyr_CCBrayEawy_193 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CCBrayEawy_193, 
                style: style_CCBrayEawy_193,
                popuplayertitle: 'CC Bray-Eawy',
                interactive: true,
                title: '<img src="styles/legend/CCBrayEawy_193.png" /> CC Bray-Eawy'
            });
var format_CCdeLondinieres_194 = new ol.format.GeoJSON();
var features_CCdeLondinieres_194 = format_CCdeLondinieres_194.readFeatures(json_CCdeLondinieres_194, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CCdeLondinieres_194 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CCdeLondinieres_194.addFeatures(features_CCdeLondinieres_194);
var lyr_CCdeLondinieres_194 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CCdeLondinieres_194, 
                style: style_CCdeLondinieres_194,
                popuplayertitle: 'CC de Londinieres',
                interactive: true,
                title: '<img src="styles/legend/CCdeLondinieres_194.png" /> CC de Londinieres'
            });
var format_Parcellescadastrales_195 = new ol.format.GeoJSON();
var features_Parcellescadastrales_195 = format_Parcellescadastrales_195.readFeatures(json_Parcellescadastrales_195, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Parcellescadastrales_195 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Parcellescadastrales_195.addFeatures(features_Parcellescadastrales_195);
var lyr_Parcellescadastrales_195 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Parcellescadastrales_195,
maxResolution:7.00111653806549,
 
                style: style_Parcellescadastrales_195,
                popuplayertitle: 'Parcelles cadastrales',
                interactive: true,
                title: '<img src="styles/legend/Parcellescadastrales_195.png" /> Parcelles cadastrales'
            });
var format_Communesassociesoudlgues_196 = new ol.format.GeoJSON();
var features_Communesassociesoudlgues_196 = format_Communesassociesoudlgues_196.readFeatures(json_Communesassociesoudlgues_196, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Communesassociesoudlgues_196 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Communesassociesoudlgues_196.addFeatures(features_Communesassociesoudlgues_196);
var lyr_Communesassociesoudlgues_196 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Communesassociesoudlgues_196, 
                style: style_Communesassociesoudlgues_196,
                popuplayertitle: 'Communes associées ou déléguées',
                interactive: false,
                title: '<img src="styles/legend/Communesassociesoudlgues_196.png" /> Communes associées ou déléguées'
            });
var format_CommunesadhrentesADS_197 = new ol.format.GeoJSON();
var features_CommunesadhrentesADS_197 = format_CommunesadhrentesADS_197.readFeatures(json_CommunesadhrentesADS_197, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CommunesadhrentesADS_197 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CommunesadhrentesADS_197.addFeatures(features_CommunesadhrentesADS_197);
var lyr_CommunesadhrentesADS_197 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CommunesadhrentesADS_197, 
                style: style_CommunesadhrentesADS_197,
                popuplayertitle: 'Communes adhérentes ADS',
                interactive: false,
                title: '<img src="styles/legend/CommunesadhrentesADS_197.png" /> Communes adhérentes ADS'
            });
var format_Communes_198 = new ol.format.GeoJSON();
var features_Communes_198 = format_Communes_198.readFeatures(json_Communes_198, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Communes_198 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Communes_198.addFeatures(features_Communes_198);
var lyr_Communes_198 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Communes_198, 
                style: style_Communes_198,
                popuplayertitle: 'Communes',
                interactive: true,
                title: '<img src="styles/legend/Communes_198.png" /> Communes'
            });
var format_Nomdescommunes_199 = new ol.format.GeoJSON();
var features_Nomdescommunes_199 = format_Nomdescommunes_199.readFeatures(json_Nomdescommunes_199, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Nomdescommunes_199 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Nomdescommunes_199.addFeatures(features_Nomdescommunes_199);
var lyr_Nomdescommunes_199 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Nomdescommunes_199, 
                style: style_Nomdescommunes_199,
                popuplayertitle: 'Nom des communes',
                interactive: false,
                title: '<img src="styles/legend/Nomdescommunes_199.png" /> Nom des communes'
            });
var group_Limitesadministratives = new ol.layer.Group({
                                layers: [lyr_CCdes4Rivires_192,lyr_CCBrayEawy_193,lyr_CCdeLondinieres_194,lyr_Parcellescadastrales_195,lyr_Communesassociesoudlgues_196,lyr_CommunesadhrentesADS_197,lyr_Communes_198,lyr_Nomdescommunes_199,],
                                fold: "open",
                                title: 'Limites administratives'});
var group_Bti = new ol.layer.Group({
                                layers: [lyr_Cimetire_184,lyr_Rservoir_185,lyr_Terraindesport_186,lyr_Monument_187,lyr_Indiffrenci_188,lyr_Industrielagricoleoucommercial_189,lyr_Constructionsponctuelles_190,lyr_Pylne_191,],
                                fold: "open",
                                title: 'Bâti'});
var group_Zonagesenvironnementaux = new ol.layer.Group({
                                layers: [lyr_ZNIEFFtype2_180,lyr_ZNIEFFtype1_181,lyr_Zoneshumides_182,lyr_Natura2000_183,],
                                fold: "open",
                                title: 'Zonages environnementaux'});
var group_Risqueshydrologiques = new ol.layer.Group({
                                layers: [lyr_Zonesimpermables_178,lyr_Remontesdenappes_179,],
                                fold: "open",
                                title: 'Risques hydrologiques'});
var group_Risquesindustriels = new ol.layer.Group({
                                layers: [lyr_ICPE_175,lyr_SitesBASOL_176,lyr_Sitespollus_177,],
                                fold: "open",
                                title: 'Risques industriels'});
var group_AZIVarenne = new ol.layer.Group({
                                layers: [lyr_Secteurs_174,],
                                fold: "open",
                                title: 'AZI Varenne'});
var group_PPRiCaillyAubetteRobec = new ol.layer.Group({
                                layers: [lyr_Zonesdalas_171,lyr_Zonesrglementaires_172,lyr_Ruissellement_173,],
                                fold: "open",
                                title: 'PPRi Cailly-Aubette-Robec'});
var group_Retraitgonflementdesargiles = new ol.layer.Group({
                                layers: [lyr_Niveaudurisque_170,],
                                fold: "open",
                                title: 'Retrait-gonflement des argiles'});
var group_Voiesdecommunication = new ol.layer.Group({
                                layers: [lyr_Itinraireautre_166,lyr_Voieferre_167,lyr_RoutesdeGrandeCirculation_168,lyr_Routesnumrotesounommes_169,],
                                fold: "open",
                                title: 'Voies de communication'});
var group_Electricit = new ol.layer.Group({
                                layers: [lyr_LignesbassetensionsouterrainesENEDIS_160,lyr_LignesbassetensionariennesENEDIS_161,lyr_LigneshautetensionsouterrainesENEDIS_162,lyr_LigneshautetensionariennesENEDIS_163,lyr_LigneshautetensionRTE_164,lyr_Postesdetransformation_165,],
                                fold: "open",
                                title: 'Electricité'});
var group_Gaz = new ol.layer.Group({
                                layers: [lyr_CanalisationsgazGRT_158,lyr_CanalisationsgazGRDF_159,],
                                fold: "open",
                                title: 'Gaz'});
var group_Hydrocarbures = new ol.layer.Group({
                                layers: [lyr_Canalisationshydrocarbures_157,],
                                fold: "open",
                                title: 'Hydrocarbures'});
var group_Bruit = new ol.layer.Group({
                                layers: [lyr_RoutesconcdesTypeC_153,lyr_RoutesconcdesTypeA_154,lyr_RoutesTypeC_155,lyr_RoutesTypeA_156,],
                                fold: "open",
                                title: 'Bruit'});
var group_Patrimoine = new ol.layer.Group({
                                layers: [lyr_Sitesauxabords_145,lyr_SUPMH_146,lyr_SPR_147,lyr_Sitesclasss_148,lyr_Sitesinscrits_149,lyr_Immeubles_150,lyr_ZPPA_151,lyr_ZPPAcentrodes_152,],
                                fold: "open",
                                title: 'Patrimoine'});
...
lyr_Sitesauxabords_145.set('fieldAliases', {'idTigre': 'idTigre', 'idApp': 'idApp', 'appTigre': 'appTigre', 'type': 'type', 'parcelle': 'parcelle', 'appelation': 'appelation', 'categorie': 'categorie', 'localisati': 'localisati', 'ressource': 'ressource', 'evenement': 'evenement', 'legende': 'legende', 'precision': 'precision', 'statut': 'statut', 'maj': 'maj', 'region': 'region', 'departemen': 'departemen', 'commune': 'commune', });
lyr_SUPMH_146.set('fieldAliases', {'idTigre': 'idTigre', 'idApp': 'idApp', 'appTigre': 'appTigre', 'type': 'type', 'parcelle': 'parcelle', 'appelation': 'appelation', 'categorie': 'categorie', 'localisati': 'localisati', 'ressource': 'ressource', 'evenement': 'evenement', 'legende': 'legende', 'precision': 'precision', 'statut': 'statut', 'maj': 'maj', 'region': 'region', 'departemen': 'departemen', 'commune': 'commune', });
lyr_SPR_147.set('fieldAliases', {'idTigre': 'idTigre', 'idApp': 'idApp', 'appTigre': 'appTigre', 'type': 'type', 'parcelle': 'parcelle', 'appelation': 'appelation', 'categorie': 'categorie', 'localisati': 'localisati', 'ressource': 'ressource', 'evenement': 'evenement', 'legende': 'legende', 'precision': 'precision', 'statut': 'statut', 'maj': 'maj', 'region': 'region', 'departemen': 'departemen', 'commune': 'commune', });
lyr_Sitesclasss_148.set('fieldAliases', {'idsite': 'idsite', 'idintgest': 'idintgest', 'dep': 'dep', 'nomsite': 'nomsite', 'type': 'type', 'descriptio': 'descriptio', 'nature': 'nature', 'datedecis': 'datedecis', 'datedecisr': 'datedecisr', 'surfoffic': 'surfoffic', 'echnum': 'echnum', 'precision': 'precision', 'srcgeogen': 'srcgeogen', 'datesrcgen': 'datesrcgen', 'surfcalc': 'surfcalc', 'surfmer': 'surfmer', 'urlfiche': 'urlfiche', 'urltxtrgl': 'urltxtrgl', 'urlcarte': 'urlcarte', 'urlcartec': 'urlcartec', 'urlweb': 'urlweb', 'urlcarmen': 'urlcarmen', });
lyr_Sitesinscrits_149.set('fieldAliases', {'idsite': 'idsite', 'idintgest': 'idintgest', 'dep': 'dep', 'nomsite': 'nomsite', 'type': 'type', 'descriptio': 'descriptio', 'nature': 'nature', 'datedecis': 'datedecis', 'datedecisr': 'datedecisr', 'surfoffic': 'surfoffic', 'echnum': 'echnum', 'precision': 'precision', 'srcgeogen': 'srcgeogen', 'datesrcgen': 'datesrcgen', 'surfcalc': 'surfcalc', 'surfmer': 'surfmer', 'urlfiche': 'urlfiche', 'urltxtrgl': 'urltxtrgl', 'urlcarte': 'urlcarte', 'urlcartec': 'urlcartec', 'urlweb': 'urlweb', 'urlcarmen': 'urlcarmen', });
lyr_Immeubles_150.set('fieldAliases', {'idTigre': 'idTigre', 'idApp': 'idApp', 'appTigre': 'appTigre', 'type': 'type', 'parcelle': 'parcelle', 'appelation': 'appelation', 'categorie': 'categorie', 'localisati': 'localisati', 'ressource': 'ressource', 'evenement': 'evenement', 'legende': 'legende', 'precision': 'precision', 'statut': 'statut', 'maj': 'maj', 'region': 'region', 'departemen': 'departemen', 'commune': 'commune', });
lyr_ZPPA_151.set('fieldAliases', {'EA_NATCODE': 'EA_NATCODE', 'COMMUNE_PP': 'COMMUNE_PP', 'NUMORDRE': 'NUMORDRE', 'NUMERO': 'NUMERO', 'NUMERO_DRA': 'NUMERO_DRA', 'NOMUSUEL': 'NOMUSUEL', 'LIEU_IGN': 'LIEU_IGN', 'LIEU_CADAS': 'LIEU_CADAS', 'VESTIGES': 'VESTIGES', 'NATURE_VES': 'NATURE_VES', 'CHRONO_DEB': 'CHRONO_DEB', 'CHRONO_FIN': 'CHRONO_FIN', 'CHRONO_FOU': 'CHRONO_FOU', 'CHRONO_DOU': 'CHRONO_DOU', 'CHRONO_PER': 'CHRONO_PER', 'COMMENT_CH': 'COMMENT_CH', 'NUMERIQUE_': 'NUMERIQUE_', 'NUMERIQU_1': 'NUMERIQU_1', 'CHRONO_D_1': 'CHRONO_D_1', 'X_SAISI': 'X_SAISI', 'Y_SAISI': 'Y_SAISI', 'SURFACE': 'SURFACE', 'PARCELLES': 'PARCELLES', 'INVENTEUR': 'INVENTEUR', 'ANNEE_DECO': 'ANNEE_DECO', 'X_DEGRE': 'X_DEGRE', 'Y_DEGRE': 'Y_DEGRE', 'EMPRISE': 'EMPRISE', 'GEOREFEREN': 'GEOREFEREN', 'GEOMETRIE': 'GEOMETRIE', });
lyr_ZPPAcentrodes_152.set('fieldAliases', {'EA_NATCODE': 'EA_NATCODE', 'COMMUNE_PP': 'COMMUNE_PP', 'NUMORDRE': 'NUMORDRE', 'NUMERO': 'NUMERO', 'NUMERO_DRA': 'NUMERO_DRA', 'NOMUSUEL': 'NOMUSUEL', 'LIEU_IGN': 'LIEU_IGN', 'LIEU_CADAS': 'LIEU_CADAS', 'VESTIGES': 'VESTIGES', 'NATURE_VES': 'NATURE_VES', 'CHRONO_DEB': 'CHRONO_DEB', 'CHRONO_FIN': 'CHRONO_FIN', 'CHRONO_FOU': 'CHRONO_FOU', 'CHRONO_DOU': 'CHRONO_DOU', 'CHRONO_PER': 'CHRONO_PER', 'COMMENT_CH': 'COMMENT_CH', 'NUMERIQUE_': 'NUMERIQUE_', 'NUMERIQU_1': 'NUMERIQU_1', 'CHRONO_D_1': 'CHRONO_D_1', 'X_SAISI': 'X_SAISI', 'Y_SAISI': 'Y_SAISI', 'SURFACE': 'SURFACE', 'PARCELLES': 'PARCELLES', 'INVENTEUR': 'INVENTEUR', 'ANNEE_DECO': 'ANNEE_DECO', 'X_DEGRE': 'X_DEGRE', 'Y_DEGRE': 'Y_DEGRE', 'EMPRISE': 'EMPRISE', 'GEOREFEREN': 'GEOREFEREN', 'GEOMETRIE': 'GEOMETRIE', });
lyr_RoutesconcdesTypeC_153.set('fieldAliases', {'IDZONBRUIT': 'IDZONBRUIT', 'IDCBS': 'IDCBS', 'ANNEE': 'ANNEE', 'CODEDEPT': 'CODEDEPT', 'TYPETERR': 'TYPETERR', 'PRODUCTEUR': 'PRODUCTEUR', 'CODINFRA': 'CODINFRA', 'TYPESOURCE': 'TYPESOURCE', 'CBSTYPE': 'CBSTYPE', 'ZONEDEF': 'ZONEDEF', 'LEGENDE': 'LEGENDE', 'VALIDEFIN': 'VALIDEFIN', 'LEG_SANEF': 'LEG_SANEF', });
lyr_RoutesconcdesTypeA_154.set('fieldAliases', {'IDZONBRUIT': 'IDZONBRUIT', 'IDCBS': 'IDCBS', 'ANNEE': 'ANNEE', 'CODEDEPT': 'CODEDEPT', 'TYPETERR': 'TYPETERR', 'PRODUCTEUR': 'PRODUCTEUR', 'CODINFRA': 'CODINFRA', 'TYPESOURCE': 'TYPESOURCE', 'CBSTYPE': 'CBSTYPE', 'ZONEDEF': 'ZONEDEF', 'LEGENDE': 'LEGENDE', 'VALIDEDEB': 'VALIDEDEB', 'VALIDEFIN': 'VALIDEFIN', 'LEGENDPROD': 'LEGENDPROD', });
lyr_RoutesTypeC_155.set('fieldAliases', {'IDZONBRUIT': 'IDZONBRUIT', 'IDCBS': 'IDCBS', 'UUEID': 'UUEID', 'ANNEE': 'ANNEE', 'CODEDEPT': 'CODEDEPT', 'TYPETERR': 'TYPETERR', 'PRODUCTEUR': 'PRODUCTEUR', 'CODINFRA': 'CODINFRA', 'TYPESOURCE': 'TYPESOURCE', 'CBSTYPE': 'CBSTYPE', 'ZONEDEF': 'ZONEDEF', 'LEGENDE': 'LEGENDE', 'INDICETYPE': 'INDICETYPE', 'VALIDEDEB': 'VALIDEDEB', 'VALIDEFIN': 'VALIDEFIN', });
lyr_RoutesTypeA_156.set('fieldAliases', {'IDZONBRUIT': 'IDZONBRUIT', 'IDCBS': 'IDCBS', 'UUEID': 'UUEID', 'ANNEE': 'ANNEE', 'CODEDEPT': 'CODEDEPT', 'TYPETERR': 'TYPETERR', 'PRODUCTEUR': 'PRODUCTEUR', 'CODINFRA': 'CODINFRA', 'TYPESOURCE': 'TYPESOURCE', 'CBSTYPE': 'CBSTYPE', 'ZONEDEF': 'ZONEDEF', 'LEGENDE': 'LEGENDE', 'INDICETYPE': 'INDICETYPE', 'VALIDEDEB': 'VALIDEDEB', 'VALIDEFIN': 'VALIDEFIN', });
lyr_Canalisationshydrocarbures_157.set('fieldAliases', {'ID': 'ID', 'NATURE': 'NATURE', 'POS_SOL': 'POS_SOL', 'ETAT': 'ETAT', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'ACQU_PLANI': 'ACQU_PLANI', 'PREC_PLANI': 'PREC_PLANI', 'ACQU_ALTI': 'ACQU_ALTI', 'PREC_ALTI': 'PREC_ALTI', });
lyr_CanalisationsgazGRT_158.set('fieldAliases', {'object_id': 'object_id', 'nom_region': 'nom_region', 'departemen': 'departemen', });
lyr_CanalisationsgazGRDF_159.set('fieldAliases', {'etat_serv': 'etat_serv', 'insee_comm': 'insee_comm', 'commune_ad': 'commune_ad', 'code_depar': 'code_depar', 'departemen': 'departemen', 'region_adm': 'region_adm', 'ID': 'ID', 'INSEE_COM': 'INSEE_COM', 'INSEE_ARR': 'INSEE_ARR', 'INSEE_COL': 'INSEE_COL', 'INSEE_DEP': 'INSEE_DEP', 'INSEE_REG': 'INSEE_REG', 'POPULATION': 'POPULATION', 'SURFACE_HA': 'SURFACE_HA', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'CODE_POST': 'CODE_POST', 'NOM': 'NOM', 'CL_ARROND': 'CL_ARROND', 'CL_COLLTER': 'CL_COLLTER', 'CL_DEPART': 'CL_DEPART', 'CL_REGION': 'CL_REGION', 'CAPITALE': 'CAPITALE', 'DATE_RCT': 'DATE_RCT', 'RECENSEUR': 'RECENSEUR', 'SIREN_EPCI': 'SIREN_EPCI', 'ID_CH_LIEU': 'ID_CH_LIEU', 'ID_AUT_ADM': 'ID_AUT_ADM', 'CODE_SIREN': 'CODE_SIREN', 'layer': 'layer', 'path': 'path', });
lyr_LignesbassetensionsouterrainesENEDIS_160.set('fieldAliases', {'code_commu': 'code_commu', 'nom_commun': 'nom_commun', 'code_epci': 'code_epci', 'nom_epci': 'nom_epci', 'code_depar': 'code_depar', 'nom_depart': 'nom_depart', 'code_regio': 'code_regio', 'nom_region': 'nom_region', });
lyr_LignesbassetensionariennesENEDIS_161.set('fieldAliases', {'code_commu': 'code_commu', 'nom_commun': 'nom_commun', 'code_epci': 'code_epci', 'nom_epci': 'nom_epci', 'code_depar': 'code_depar', 'nom_depart': 'nom_depart', 'code_regio': 'code_regio', 'nom_region': 'nom_region', });
lyr_LigneshautetensionsouterrainesENEDIS_162.set('fieldAliases', {'code_commu': 'code_commu', 'nom_commun': 'nom_commun', 'code_epci': 'code_epci', 'nom_epci': 'nom_epci', 'code_depar': 'code_depar', 'nom_depart': 'nom_depart', 'code_regio': 'code_regio', 'nom_region': 'nom_region', });
lyr_LigneshautetensionariennesENEDIS_163.set('fieldAliases', {'code_commu': 'code_commu', 'nom_commun': 'nom_commun', 'code_epci': 'code_epci', 'nom_epci': 'nom_epci', 'code_depar': 'code_depar', 'nom_depart': 'nom_depart', 'code_regio': 'code_regio', 'nom_region': 'nom_region', });
lyr_LigneshautetensionRTE_164.set('fieldAliases', {'ID': 'ID', 'VOLTAGE': 'VOLTAGE', 'ETAT': 'ETAT', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'ACQU_PLANI': 'ACQU_PLANI', 'PREC_PLANI': 'PREC_PLANI', 'ACQU_ALTI': 'ACQU_ALTI', 'PREC_ALTI': 'PREC_ALTI', });
lyr_Postesdetransformation_165.set('fieldAliases', {'ID': 'ID', 'TOPONYME': 'TOPONYME', 'STATUT_TOP': 'STATUT_TOP', 'IMPORTANCE': 'IMPORTANCE', 'ETAT': 'ETAT', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'ACQU_PLANI': 'ACQU_PLANI', 'PREC_PLANI': 'PREC_PLANI', 'ACQU_ALTI': 'ACQU_ALTI', 'PREC_ALTI': 'PREC_ALTI', });
lyr_Itinraireautre_166.set('fieldAliases', {'ID': 'ID', 'NATURE': 'NATURE', 'NAT_DETAIL': 'NAT_DETAIL', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', });
lyr_Voieferre_167.set('fieldAliases', {'ID': 'ID', 'NATURE': 'NATURE', 'POS_SOL': 'POS_SOL', 'ETAT': 'ETAT', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'ACQU_PLANI': 'ACQU_PLANI', 'PREC_PLANI': 'PREC_PLANI', 'ACQU_ALTI': 'ACQU_ALTI', 'PREC_ALTI': 'PREC_ALTI', 'ELECTRIFIE': 'ELECTRIFIE', 'LARGEUR': 'LARGEUR', 'NB_VOIES': 'NB_VOIES', 'USAGE': 'USAGE', 'VITES_MAX': 'VITES_MAX', 'ID_VFN': 'ID_VFN', 'TOPONYME': 'TOPONYME', });
lyr_RoutesdeGrandeCirculation_168.set('fieldAliases', {'objectid': 'objectid', 'axe': 'axe', 'cumuld': 'cumuld', 'cumulf': 'cumulf', 'plod': 'plod', 'absd': 'absd', 'plof': 'plof', 'absf': 'absf', 'xd': 'xd', 'yd': 'yd', 'zd': 'zd', 'xf': 'xf', 'yf': 'yf', 'zf': 'zf', 'cote': 'cote', 'emplacemen': 'emplacemen', 'voie': 'voie', 'distance': 'distance', 'accrochage': 'accrochage', 'objetid': 'objetid', 'longueur': 'longueur', 'releve_xy': 'releve_xy', 'parent_id': 'parent_id', 'validation': 'validation', 'status': 'status', 'link_id': 'link_id', 'import': 'import', 'user_creat': 'user_creat', 'date_creat': 'date_creat', 'user_modif': 'user_modif', 'date_modif': 'date_modif', 'territoire': 'territoire', 'daterefere': 'daterefere', 'chaussee': 'chaussee', 'id_prj': 'id_prj', 'date_grde_': 'date_grde_', 'grande_cir': 'grande_cir', 'SHAPE_Leng': 'SHAPE_Leng', });
lyr_Routesnumrotesounommes_169.set('fieldAliases', {'ID': 'ID', 'TYPE_ROUTE': 'TYPE_ROUTE', 'NUMERO': 'NUMERO', 'TOPONYME': 'TOPONYME', 'STATUT_TOP': 'STATUT_TOP', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'GESTION': 'GESTION', });
lyr_Niveaudurisque_170.set('fieldAliases', {'dpt': 'dpt', 'niveau': 'niveau', 'alea': 'alea', });
lyr_Zonesdalas_171.set('fieldAliases', {'ID_ZONE': 'ID_ZONE', 'ID_GASPAR': 'ID_GASPAR', 'DESCRIPT': 'DESCRIPT', 'CODERISQUE': 'CODERISQUE', 'NOMRISQUE': 'NOMRISQUE', 'NIVALEA': 'NIVALEA', 'NIVALEA_ST': 'NIVALEA_ST', 'TITRECARTE': 'TITRECARTE', 'DATECARTE': 'DATECARTE', 'ID_MAP': 'ID_MAP', });
lyr_Zonesrglementaires_172.set('fieldAliases', {'id': 'id', 'id_map': 'id_map', 'id_zone': 'id_zone', 'id_gaspar': 'id_gaspar', 'nom': 'nom', 'codezone': 'codezone', 'soumisalea': 'soumisalea', 'typereg': 'typereg', });
lyr_Ruissellement_173.set('fieldAliases', {'id': 'id', 'id_map': 'id_map', 'id_zone': 'id_zone', 'id_gaspar': 'id_gaspar', 'nom': 'nom', 'codezone': 'codezone', 'soumisalea': 'soumisalea', 'typereg': 'typereg', });
lyr_Secteurs_174.set('fieldAliases', {'ALEA': 'ALEA', });
lyr_ICPE_175.set('fieldAliases', {'code_aiot': 'code_aiot', 'x': 'x', 'y': 'y', 'code_epsg': 'code_epsg', 'nom_ets': 'nom_ets', 'num_dep': 'num_dep', 'adresse': 'adresse', 'cd_insee': 'cd_insee', 'cd_postal': 'cd_postal', 'commune': 'commune', 'code_naf': 'code_naf', 'lib_naf': 'lib_naf', 'num_siret': 'num_siret', 'cd_regime': 'cd_regime', 'lib_regime': 'lib_regime', 'seveso': 'seveso', 'lib_seveso': 'lib_seveso', 'bovins': 'bovins', 'porcs': 'porcs', 'volailles': 'volailles', 'carriere': 'carriere', 'eolienne': 'eolienne', 'industrie': 'industrie', 'ied': 'ied', 'priorite_n': 'priorite_n', 'url_fiche': 'url_fiche', });
lyr_SitesBASOL_176.set('fieldAliases', {'cd_metier': 'cd_metier', 'autre_id': 'autre_id', 'nom_etab': 'nom_etab', 'nom_instr': 'nom_instr', 'code_siret': 'code_siret', 'stat_instr': 'stat_instr', 'date_debut': 'date_debut', 'date_fin': 'date_fin', 'descript': 'descript', 'code_insee': 'code_insee', 'nom_com': 'nom_com', 'x_wgs84': 'x_wgs84', 'y_wgs84': 'y_wgs84', 'code_dpt': 'code_dpt', 'nom_dpt': 'nom_dpt', 'code_reg': 'code_reg', 'nom_reg': 'nom_reg', 'act_nafv2': 'act_nafv2', 'act_naf': 'act_naf', 'act_icpe': 'act_icpe', 'act_nafv1': 'act_nafv1', });
lyr_Sitespollus_177.set('fieldAliases', {'cd_metier': 'cd_metier', 'autre_id': 'autre_id', 'nom_ets': 'nom_ets', 'nom_site': 'nom_site', 'code_siret': 'code_siret', 'stat_instr': 'stat_instr', 'date_debut': 'date_debut', 'date_fin': 'date_fin', 'descript': 'descript', 'code_insee': 'code_insee', 'nom_com': 'nom_com', 'x_wgs84': 'x_wgs84', 'y_wgs84': 'y_wgs84', 'code_dpt': 'code_dpt', 'nom_dpt': 'nom_dpt', 'code_reg': 'code_reg', 'nom_reg': 'nom_reg', 'act_nafv2': 'act_nafv2', 'act_naf': 'act_naf', 'act_icpe': 'act_icpe', 'act_nafv1': 'act_nafv1', });
lyr_Zonesimpermables_178.set('fieldAliases', {'Id': 'Id', });
lyr_Remontesdenappes_179.set('fieldAliases', {'CLASSE': 'CLASSE', 'FIAB_MNT': 'FIAB_MNT', 'FIAB_ESO': 'FIAB_ESO', 'FIAB_TOT': 'FIAB_TOT', 'CLASSEFIAB': 'CLASSEFIAB', 'gridcode': 'gridcode', });
lyr_ZNIEFFtype2_180.set('fieldAliases', {'NOM_ZNIEFF': 'NOM_ZNIEFF', 'CODE_NATIO': 'CODE_NATIO', 'CODE_REGIO': 'CODE_REGIO', 'SURFACE_HA': 'SURFACE_HA', 'SAISIE_LOG': 'SAISIE_LOG', 'DATE_DE_VA': 'DATE_DE_VA', 'ORGANISME': 'ORGANISME', 'INCLUSION': 'INCLUSION', 'DEPARTEMEN': 'DEPARTEMEN', 'URLFICTECH': 'URLFICTECH', 'URLFICPUB': 'URLFICPUB', 'URLMETAD': 'URLMETAD', });
lyr_ZNIEFFtype1_181.set('fieldAliases', {'NOM_ZNIEFF': 'NOM_ZNIEFF', 'CODE_NATIO': 'CODE_NATIO', 'CODE_REGIO': 'CODE_REGIO', 'SURFACE_HA': 'SURFACE_HA', 'SAISIE_LOG': 'SAISIE_LOG', 'DATE_DE_VA': 'DATE_DE_VA', 'ORGANISME': 'ORGANISME', 'INCLUSION': 'INCLUSION', 'DEPARTEMEN': 'DEPARTEMEN', 'URLFICTECH': 'URLFICTECH', 'URLFICPUB': 'URLFICPUB', 'URLMETAD': 'URLMETAD', });
lyr_Zoneshumides_182.set('fieldAliases', {'LIBELLE': 'LIBELLE', 'URLMETAD': 'URLMETAD', });
lyr_Natura2000_183.set('fieldAliases', {'SITECODE': 'SITECODE', 'SITENAME': 'SITENAME', });
lyr_Cimetire_184.set('fieldAliases', {'ID': 'ID', 'NATURE': 'NATURE', 'NAT_DETAIL': 'NAT_DETAIL', 'TOPONYME': 'TOPONYME', 'STATUT_TOP': 'STATUT_TOP', 'IMPORTANCE': 'IMPORTANCE', 'ETAT': 'ETAT', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'ACQU_PLANI': 'ACQU_PLANI', 'PREC_PLANI': 'PREC_PLANI', 'ACQU_ALTI': 'ACQU_ALTI', 'PREC_ALTI': 'PREC_ALTI', });
lyr_Rservoir_185.set('fieldAliases', {'ID': 'ID', 'NATURE': 'NATURE', 'ETAT': 'ETAT', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'ACQU_PLANI': 'ACQU_PLANI', 'PREC_PLANI': 'PREC_PLANI', 'ACQU_ALTI': 'ACQU_ALTI', 'PREC_ALTI': 'PREC_ALTI', 'Z_MIN_SOL': 'Z_MIN_SOL', 'Z_MIN_TOIT': 'Z_MIN_TOIT', 'HAUTEUR': 'HAUTEUR', 'Z_MAX_TOIT': 'Z_MAX_TOIT', 'Z_MAX_SOL': 'Z_MAX_SOL', 'ORIGIN_BAT': 'ORIGIN_BAT', 'VOLUME': 'VOLUME', });
lyr_Terraindesport_186.set('fieldAliases', {'ID': 'ID', 'NATURE': 'NATURE', 'NAT_DETAIL': 'NAT_DETAIL', 'ETAT': 'ETAT', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'ACQU_PLANI': 'ACQU_PLANI', 'PREC_PLANI': 'PREC_PLANI', 'ACQU_ALTI': 'ACQU_ALTI', 'PREC_ALTI': 'PREC_ALTI', });
lyr_Monument_187.set('fieldAliases', {'ID': 'ID', 'NATURE': 'NATURE', 'USAGE1': 'USAGE1', 'USAGE2': 'USAGE2', 'LEGER': 'LEGER', 'ETAT': 'ETAT', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'ACQU_PLANI': 'ACQU_PLANI', 'ACQU_ALTI': 'ACQU_ALTI', 'PREC_PLANI': 'PREC_PLANI', 'PREC_ALTI': 'PREC_ALTI', 'NB_LOGTS': 'NB_LOGTS', 'NB_ETAGES': 'NB_ETAGES', 'MAT_MURS': 'MAT_MURS', 'MAT_TOITS': 'MAT_TOITS', 'HAUTEUR': 'HAUTEUR', 'Z_MIN_SOL': 'Z_MIN_SOL', 'Z_MIN_TOIT': 'Z_MIN_TOIT', 'Z_MAX_TOIT': 'Z_MAX_TOIT', 'Z_MAX_SOL': 'Z_MAX_SOL', 'ORIGIN_BAT': 'ORIGIN_BAT', 'APP_FF': 'APP_FF', 'IDS_RNB': 'IDS_RNB', });
lyr_Indiffrenci_188.set('fieldAliases', {'ID': 'ID', 'NATURE': 'NATURE', 'USAGE1': 'USAGE1', 'USAGE2': 'USAGE2', 'LEGER': 'LEGER', 'ETAT': 'ETAT', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'ACQU_PLANI': 'ACQU_PLANI', 'ACQU_ALTI': 'ACQU_ALTI', 'PREC_PLANI': 'PREC_PLANI', 'PREC_ALTI': 'PREC_ALTI', 'NB_LOGTS': 'NB_LOGTS', 'NB_ETAGES': 'NB_ETAGES', 'MAT_MURS': 'MAT_MURS', 'MAT_TOITS': 'MAT_TOITS', 'HAUTEUR': 'HAUTEUR', 'Z_MIN_SOL': 'Z_MIN_SOL', 'Z_MIN_TOIT': 'Z_MIN_TOIT', 'Z_MAX_TOIT': 'Z_MAX_TOIT', 'Z_MAX_SOL': 'Z_MAX_SOL', 'ORIGIN_BAT': 'ORIGIN_BAT', 'APP_FF': 'APP_FF', 'IDS_RNB': 'IDS_RNB', });
lyr_Industrielagricoleoucommercial_189.set('fieldAliases', {'ID': 'ID', 'NATURE': 'NATURE', 'USAGE1': 'USAGE1', 'USAGE2': 'USAGE2', 'LEGER': 'LEGER', 'ETAT': 'ETAT', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'ACQU_PLANI': 'ACQU_PLANI', 'ACQU_ALTI': 'ACQU_ALTI', 'PREC_PLANI': 'PREC_PLANI', 'PREC_ALTI': 'PREC_ALTI', 'NB_LOGTS': 'NB_LOGTS', 'NB_ETAGES': 'NB_ETAGES', 'MAT_MURS': 'MAT_MURS', 'MAT_TOITS': 'MAT_TOITS', 'HAUTEUR': 'HAUTEUR', 'Z_MIN_SOL': 'Z_MIN_SOL', 'Z_MIN_TOIT': 'Z_MIN_TOIT', 'Z_MAX_TOIT': 'Z_MAX_TOIT', 'Z_MAX_SOL': 'Z_MAX_SOL', 'ORIGIN_BAT': 'ORIGIN_BAT', 'APP_FF': 'APP_FF', 'IDS_RNB': 'IDS_RNB', });
lyr_Constructionsponctuelles_190.set('fieldAliases', {'ID': 'ID', 'NATURE': 'NATURE', 'NAT_DETAIL': 'NAT_DETAIL', 'TOPONYME': 'TOPONYME', 'STATUT_TOP': 'STATUT_TOP', 'IMPORTANCE': 'IMPORTANCE', 'ETAT': 'ETAT', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'ACQU_PLANI': 'ACQU_PLANI', 'PREC_PLANI': 'PREC_PLANI', 'ACQU_ALTI': 'ACQU_ALTI', 'PREC_ALTI': 'PREC_ALTI', 'HAUTEUR': 'HAUTEUR', });
lyr_Pylne_191.set('fieldAliases', {'ID': 'ID', 'ETAT': 'ETAT', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'SOURCE': 'SOURCE', 'ID_SOURCE': 'ID_SOURCE', 'ACQU_PLANI': 'ACQU_PLANI', 'PREC_PLANI': 'PREC_PLANI', 'ACQU_ALTI': 'ACQU_ALTI', 'PREC_ALTI': 'PREC_ALTI', 'HAUTEUR': 'HAUTEUR', });
lyr_CCdes4Rivires_192.set('fieldAliases', {'ID': 'ID', 'CODE_SIREN': 'CODE_SIREN', 'NATURE': 'NATURE', 'NOM': 'NOM', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'ID_AUT_ADM': 'ID_AUT_ADM', });
lyr_CCBrayEawy_193.set('fieldAliases', {'ID': 'ID', 'CODE_SIREN': 'CODE_SIREN', 'NATURE': 'NATURE', 'NOM': 'NOM', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'ID_AUT_ADM': 'ID_AUT_ADM', });
lyr_CCdeLondinieres_194.set('fieldAliases', {'ID': 'ID', 'CODE_SIREN': 'CODE_SIREN', 'NATURE': 'NATURE', 'NOM': 'NOM', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'ID_AUT_ADM': 'ID_AUT_ADM', });
lyr_Parcellescadastrales_195.set('fieldAliases', {'id': 'id', 'commune': 'commune', 'prefixe': 'prefixe', 'section': 'section', 'numero': 'numero', 'contenance': 'contenance', 'created': 'created', 'updated': 'updated', 'layer': 'layer', 'path': 'path', });
lyr_Communesassociesoudlgues_196.set('fieldAliases', {'ID': 'ID', 'INSEE_CAD': 'INSEE_CAD', 'INSEE_COM': 'INSEE_COM', 'NATURE': 'NATURE', 'NOM': 'NOM', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'CODE_POST': 'CODE_POST', 'ID_CH_LIEU': 'ID_CH_LIEU', 'ID_AUT_ADM': 'ID_AUT_ADM', 'POPULATION': 'POPULATION', 'CODE_SIREN': 'CODE_SIREN', });
lyr_CommunesadhrentesADS_197.set('fieldAliases', {'ID': 'ID', 'INSEE_COM': 'INSEE_COM', 'INSEE_ARR': 'INSEE_ARR', 'INSEE_COL': 'INSEE_COL', 'INSEE_DEP': 'INSEE_DEP', 'INSEE_REG': 'INSEE_REG', 'POPULATION': 'POPULATION', 'SURFACE_HA': 'SURFACE_HA', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'CODE_POST': 'CODE_POST', 'NOM': 'NOM', 'CL_ARROND': 'CL_ARROND', 'CL_COLLTER': 'CL_COLLTER', 'CL_DEPART': 'CL_DEPART', 'CL_REGION': 'CL_REGION', 'CAPITALE': 'CAPITALE', 'DATE_RCT': 'DATE_RCT', 'RECENSEUR': 'RECENSEUR', 'SIREN_EPCI': 'SIREN_EPCI', 'ID_CH_LIEU': 'ID_CH_LIEU', 'ID_AUT_ADM': 'ID_AUT_ADM', 'CODE_SIREN': 'CODE_SIREN', 'layer': 'layer', 'path': 'path', });
lyr_Communes_198.set('fieldAliases', {'ID': 'ID', 'INSEE_COM': 'INSEE_COM', 'INSEE_ARR': 'INSEE_ARR', 'INSEE_COL': 'INSEE_COL', 'INSEE_DEP': 'INSEE_DEP', 'INSEE_REG': 'INSEE_REG', 'POPULATION': 'POPULATION', 'SURFACE_HA': 'SURFACE_HA', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'CODE_POST': 'CODE_POST', 'NOM': 'NOM', 'CL_ARROND': 'CL_ARROND', 'CL_COLLTER': 'CL_COLLTER', 'CL_DEPART': 'CL_DEPART', 'CL_REGION': 'CL_REGION', 'CAPITALE': 'CAPITALE', 'DATE_RCT': 'DATE_RCT', 'RECENSEUR': 'RECENSEUR', 'SIREN_EPCI': 'SIREN_EPCI', 'ID_CH_LIEU': 'ID_CH_LIEU', 'ID_AUT_ADM': 'ID_AUT_ADM', 'CODE_SIREN': 'CODE_SIREN', 'layer': 'layer', 'path': 'path', });
lyr_Nomdescommunes_199.set('fieldAliases', {'ID': 'ID', 'INSEE_COM': 'INSEE_COM', 'INSEE_ARR': 'INSEE_ARR', 'INSEE_COL': 'INSEE_COL', 'INSEE_DEP': 'INSEE_DEP', 'INSEE_REG': 'INSEE_REG', 'POPULATION': 'POPULATION', 'SURFACE_HA': 'SURFACE_HA', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'CODE_POST': 'CODE_POST', 'NOM': 'NOM', 'CL_ARROND': 'CL_ARROND', 'CL_COLLTER': 'CL_COLLTER', 'CL_DEPART': 'CL_DEPART', 'CL_REGION': 'CL_REGION', 'CAPITALE': 'CAPITALE', 'DATE_RCT': 'DATE_RCT', 'RECENSEUR': 'RECENSEUR', 'SIREN_EPCI': 'SIREN_EPCI', 'ID_CH_LIEU': 'ID_CH_LIEU', 'ID_AUT_ADM': 'ID_AUT_ADM', 'CODE_SIREN': 'CODE_SIREN', 'layer': 'layer', 'path': 'path', });
...
lyr_Sitesauxabords_145.set('fieldImages', {'idTigre': 'TextEdit', 'idApp': 'TextEdit', 'appTigre': 'TextEdit', 'type': 'TextEdit', 'parcelle': 'TextEdit', 'appelation': 'TextEdit', 'categorie': 'TextEdit', 'localisati': 'TextEdit', 'ressource': 'TextEdit', 'evenement': 'TextEdit', 'legende': 'TextEdit', 'precision': 'TextEdit', 'statut': 'TextEdit', 'maj': 'TextEdit', 'region': 'TextEdit', 'departemen': 'TextEdit', 'commune': 'TextEdit', });
lyr_SUPMH_146.set('fieldImages', {'idTigre': 'Range', 'idApp': 'TextEdit', 'appTigre': 'Range', 'type': 'TextEdit', 'parcelle': 'TextEdit', 'appelation': 'TextEdit', 'categorie': 'TextEdit', 'localisati': 'TextEdit', 'ressource': 'TextEdit', 'evenement': 'TextEdit', 'legende': 'TextEdit', 'precision': 'TextEdit', 'statut': 'TextEdit', 'maj': 'TextEdit', 'region': 'TextEdit', 'departemen': 'TextEdit', 'commune': 'TextEdit', });
lyr_SPR_147.set('fieldImages', {'idTigre': 'Range', 'idApp': 'TextEdit', 'appTigre': 'Range', 'type': 'TextEdit', 'parcelle': 'TextEdit', 'appelation': 'TextEdit', 'categorie': 'TextEdit', 'localisati': 'TextEdit', 'ressource': 'TextEdit', 'evenement': 'TextEdit', 'legende': 'TextEdit', 'precision': 'TextEdit', 'statut': 'TextEdit', 'maj': 'TextEdit', 'region': 'TextEdit', 'departemen': 'TextEdit', 'commune': 'TextEdit', });
lyr_Sitesclasss_148.set('fieldImages', {'idsite': 'TextEdit', 'idintgest': 'TextEdit', 'dep': 'TextEdit', 'nomsite': 'TextEdit', 'type': 'TextEdit', 'descriptio': 'TextEdit', 'nature': 'TextEdit', 'datedecis': 'TextEdit', 'datedecisr': 'TextEdit', 'surfoffic': 'TextEdit', 'echnum': 'TextEdit', 'precision': 'TextEdit', 'srcgeogen': 'TextEdit', 'datesrcgen': 'TextEdit', 'surfcalc': 'TextEdit', 'surfmer': 'TextEdit', 'urlfiche': 'TextEdit', 'urltxtrgl': 'TextEdit', 'urlcarte': 'TextEdit', 'urlcartec': 'TextEdit', 'urlweb': 'TextEdit', 'urlcarmen': 'TextEdit', });
lyr_Sitesinscrits_149.set('fieldImages', {'idsite': 'TextEdit', 'idintgest': 'TextEdit', 'dep': 'TextEdit', 'nomsite': 'TextEdit', 'type': 'TextEdit', 'descriptio': 'TextEdit', 'nature': 'TextEdit', 'datedecis': 'TextEdit', 'datedecisr': 'TextEdit', 'surfoffic': 'TextEdit', 'echnum': 'TextEdit', 'precision': 'TextEdit', 'srcgeogen': 'TextEdit', 'datesrcgen': 'TextEdit', 'surfcalc': 'TextEdit', 'surfmer': 'TextEdit', 'urlfiche': 'TextEdit', 'urltxtrgl': 'TextEdit', 'urlcarte': 'TextEdit', 'urlcartec': 'TextEdit', 'urlweb': 'TextEdit', 'urlcarmen': 'TextEdit', });
lyr_Immeubles_150.set('fieldImages', {'idTigre': 'Range', 'idApp': 'TextEdit', 'appTigre': 'Range', 'type': 'TextEdit', 'parcelle': 'TextEdit', 'appelation': 'TextEdit', 'categorie': 'TextEdit', 'localisati': 'TextEdit', 'ressource': 'TextEdit', 'evenement': 'TextEdit', 'legende': 'TextEdit', 'precision': 'TextEdit', 'statut': 'TextEdit', 'maj': 'TextEdit', 'region': 'TextEdit', 'departemen': 'TextEdit', 'commune': 'TextEdit', });
lyr_ZPPA_151.set('fieldImages', {'EA_NATCODE': 'TextEdit', 'COMMUNE_PP': 'TextEdit', 'NUMORDRE': 'Range', 'NUMERO': 'TextEdit', 'NUMERO_DRA': 'TextEdit', 'NOMUSUEL': 'TextEdit', 'LIEU_IGN': 'TextEdit', 'LIEU_CADAS': 'TextEdit', 'VESTIGES': 'TextEdit', 'NATURE_VES': 'TextEdit', 'CHRONO_DEB': 'TextEdit', 'CHRONO_FIN': 'TextEdit', 'CHRONO_FOU': 'TextEdit', 'CHRONO_DOU': 'TextEdit', 'CHRONO_PER': 'TextEdit', 'COMMENT_CH': 'TextEdit', 'NUMERIQUE_': 'TextEdit', 'NUMERIQU_1': 'TextEdit', 'CHRONO_D_1': 'TextEdit', 'X_SAISI': 'TextEdit', 'Y_SAISI': 'TextEdit', 'SURFACE': 'TextEdit', 'PARCELLES': 'TextEdit', 'INVENTEUR': 'TextEdit', 'ANNEE_DECO': 'Range', 'X_DEGRE': 'TextEdit', 'Y_DEGRE': 'TextEdit', 'EMPRISE': 'TextEdit', 'GEOREFEREN': 'TextEdit', 'GEOMETRIE': 'TextEdit', });
lyr_ZPPAcentrodes_152.set('fieldImages', {'EA_NATCODE': 'TextEdit', 'COMMUNE_PP': 'TextEdit', 'NUMORDRE': 'Range', 'NUMERO': 'TextEdit', 'NUMERO_DRA': 'TextEdit', 'NOMUSUEL': 'TextEdit', 'LIEU_IGN': 'TextEdit', 'LIEU_CADAS': 'TextEdit', 'VESTIGES': 'TextEdit', 'NATURE_VES': 'TextEdit', 'CHRONO_DEB': 'TextEdit', 'CHRONO_FIN': 'TextEdit', 'CHRONO_FOU': 'TextEdit', 'CHRONO_DOU': 'TextEdit', 'CHRONO_PER': 'TextEdit', 'COMMENT_CH': 'TextEdit', 'NUMERIQUE_': 'TextEdit', 'NUMERIQU_1': 'TextEdit', 'CHRONO_D_1': 'TextEdit', 'X_SAISI': 'TextEdit', 'Y_SAISI': 'TextEdit', 'SURFACE': 'TextEdit', 'PARCELLES': 'TextEdit', 'INVENTEUR': 'TextEdit', 'ANNEE_DECO': 'Range', 'X_DEGRE': 'TextEdit', 'Y_DEGRE': 'TextEdit', 'EMPRISE': 'TextEdit', 'GEOREFEREN': 'TextEdit', 'GEOMETRIE': 'TextEdit', });
lyr_RoutesconcdesTypeC_153.set('fieldImages', {'IDZONBRUIT': 'TextEdit', 'IDCBS': 'TextEdit', 'ANNEE': 'TextEdit', 'CODEDEPT': 'TextEdit', 'TYPETERR': 'TextEdit', 'PRODUCTEUR': 'TextEdit', 'CODINFRA': 'TextEdit', 'TYPESOURCE': 'TextEdit', 'CBSTYPE': 'TextEdit', 'ZONEDEF': 'TextEdit', 'LEGENDE': 'TextEdit', 'VALIDEFIN': 'DateTime', 'LEG_SANEF': 'TextEdit', });
lyr_RoutesconcdesTypeA_154.set('fieldImages', {'IDZONBRUIT': 'TextEdit', 'IDCBS': 'TextEdit', 'ANNEE': 'TextEdit', 'CODEDEPT': 'TextEdit', 'TYPETERR': 'TextEdit', 'PRODUCTEUR': 'TextEdit', 'CODINFRA': 'TextEdit', 'TYPESOURCE': 'TextEdit', 'CBSTYPE': 'TextEdit', 'ZONEDEF': 'TextEdit', 'LEGENDE': 'TextEdit', 'VALIDEDEB': 'DateTime', 'VALIDEFIN': 'DateTime', 'LEGENDPROD': 'TextEdit', });
lyr_RoutesTypeC_155.set('fieldImages', {'IDZONBRUIT': 'TextEdit', 'IDCBS': 'TextEdit', 'UUEID': 'TextEdit', 'ANNEE': 'TextEdit', 'CODEDEPT': 'TextEdit', 'TYPETERR': 'TextEdit', 'PRODUCTEUR': 'TextEdit', 'CODINFRA': 'TextEdit', 'TYPESOURCE': 'TextEdit', 'CBSTYPE': 'TextEdit', 'ZONEDEF': 'TextEdit', 'LEGENDE': 'TextEdit', 'INDICETYPE': 'TextEdit', 'VALIDEDEB': 'DateTime', 'VALIDEFIN': 'DateTime', });
lyr_RoutesTypeA_156.set('fieldImages', {'IDZONBRUIT': 'TextEdit', 'IDCBS': 'TextEdit', 'UUEID': 'TextEdit', 'ANNEE': 'TextEdit', 'CODEDEPT': 'TextEdit', 'TYPETERR': 'TextEdit', 'PRODUCTEUR': 'TextEdit', 'CODINFRA': 'TextEdit', 'TYPESOURCE': 'TextEdit', 'CBSTYPE': 'TextEdit', 'ZONEDEF': 'TextEdit', 'LEGENDE': 'TextEdit', 'INDICETYPE': 'TextEdit', 'VALIDEDEB': 'DateTime', 'VALIDEFIN': 'DateTime', });
lyr_Canalisationshydrocarbures_157.set('fieldImages', {'ID': 'TextEdit', 'NATURE': 'TextEdit', 'POS_SOL': 'TextEdit', 'ETAT': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'SOURCE': 'TextEdit', 'ID_SOURCE': 'TextEdit', 'ACQU_PLANI': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'ACQU_ALTI': 'TextEdit', 'PREC_ALTI': 'TextEdit', });
lyr_CanalisationsgazGRT_158.set('fieldImages', {'object_id': 'TextEdit', 'nom_region': 'TextEdit', 'departemen': 'TextEdit', });
lyr_CanalisationsgazGRDF_159.set('fieldImages', {'etat_serv': 'TextEdit', 'insee_comm': 'TextEdit', 'commune_ad': 'TextEdit', 'code_depar': 'TextEdit', 'departemen': 'TextEdit', 'region_adm': 'TextEdit', 'ID': 'TextEdit', 'INSEE_COM': 'TextEdit', 'INSEE_ARR': 'TextEdit', 'INSEE_COL': 'TextEdit', 'INSEE_DEP': 'TextEdit', 'INSEE_REG': 'TextEdit', 'POPULATION': 'Range', 'SURFACE_HA': 'Range', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'CODE_POST': 'TextEdit', 'NOM': 'TextEdit', 'CL_ARROND': 'TextEdit', 'CL_COLLTER': 'TextEdit', 'CL_DEPART': 'TextEdit', 'CL_REGION': 'TextEdit', 'CAPITALE': 'TextEdit', 'DATE_RCT': 'DateTime', 'RECENSEUR': 'TextEdit', 'SIREN_EPCI': 'TextEdit', 'ID_CH_LIEU': 'TextEdit', 'ID_AUT_ADM': 'TextEdit', 'CODE_SIREN': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', });
lyr_LignesbassetensionsouterrainesENEDIS_160.set('fieldImages', {'code_commu': '', 'nom_commun': '', 'code_epci': 'TextEdit', 'nom_epci': 'TextEdit', 'code_depar': '', 'nom_depart': '', 'code_regio': '', 'nom_region': 'TextEdit', });
lyr_LignesbassetensionariennesENEDIS_161.set('fieldImages', {'code_commu': '', 'nom_commun': '', 'code_epci': 'TextEdit', 'nom_epci': 'TextEdit', 'code_depar': '', 'nom_depart': '', 'code_regio': '', 'nom_region': 'TextEdit', });
lyr_LigneshautetensionsouterrainesENEDIS_162.set('fieldImages', {'code_commu': '', 'nom_commun': '', 'code_epci': 'TextEdit', 'nom_epci': 'TextEdit', 'code_depar': '', 'nom_depart': '', 'code_regio': '', 'nom_region': 'TextEdit', });
lyr_LigneshautetensionariennesENEDIS_163.set('fieldImages', {'code_commu': '', 'nom_commun': '', 'code_epci': 'TextEdit', 'nom_epci': 'TextEdit', 'code_depar': '', 'nom_depart': '', 'code_regio': '', 'nom_region': 'TextEdit', });
lyr_LigneshautetensionRTE_164.set('fieldImages', {'ID': 'TextEdit', 'VOLTAGE': 'TextEdit', 'ETAT': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'SOURCE': 'TextEdit', 'ID_SOURCE': 'TextEdit', 'ACQU_PLANI': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'ACQU_ALTI': 'TextEdit', 'PREC_ALTI': 'TextEdit', });
lyr_Postesdetransformation_165.set('fieldImages', {'ID': '', 'TOPONYME': '', 'STATUT_TOP': '', 'IMPORTANCE': '', 'ETAT': '', 'DATE_CREAT': '', 'DATE_MAJ': '', 'DATE_APP': '', 'DATE_CONF': '', 'SOURCE': '', 'ID_SOURCE': '', 'ACQU_PLANI': '', 'PREC_PLANI': '', 'ACQU_ALTI': '', 'PREC_ALTI': '', });
lyr_Itinraireautre_166.set('fieldImages', {'ID': 'TextEdit', 'NATURE': 'TextEdit', 'NAT_DETAIL': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'SOURCE': 'TextEdit', 'ID_SOURCE': 'TextEdit', });
...
lyr_RoutesdeGrandeCirculation_168.set('fieldImages', {'objectid': 'Range', 'axe': 'TextEdit', 'cumuld': 'Range', 'cumulf': 'Range', 'plod': 'TextEdit', 'absd': 'Range', 'plof': 'TextEdit', 'absf': 'Range', 'xd': 'TextEdit', 'yd': 'TextEdit', 'zd': 'TextEdit', 'xf': 'TextEdit', 'yf': 'TextEdit', 'zf': 'TextEdit', 'cote': 'TextEdit', 'emplacemen': 'TextEdit', 'voie': 'Range', 'distance': 'TextEdit', 'accrochage': 'Range', 'objetid': 'Range', 'longueur': 'TextEdit', 'releve_xy': 'TextEdit', 'parent_id': 'Range', 'validation': 'Range', 'status': 'Range', 'link_id': 'Range', 'import': 'Range', 'user_creat': 'TextEdit', 'date_creat': 'DateTime', 'user_modif': 'TextEdit', 'date_modif': 'DateTime', 'territoire': 'TextEdit', 'daterefere': 'DateTime', 'chaussee': 'TextEdit', 'id_prj': 'Range', 'date_grde_': 'Range', 'grande_cir': 'TextEdit', 'SHAPE_Leng': 'TextEdit', });
lyr_Routesnumrotesounommes_169.set('fieldImages', {'ID': 'TextEdit', 'TYPE_ROUTE': 'TextEdit', 'NUMERO': 'TextEdit', 'TOPONYME': 'TextEdit', 'STATUT_TOP': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'SOURCE': 'TextEdit', 'ID_SOURCE': 'TextEdit', 'GESTION': 'TextEdit', });
lyr_Niveaudurisque_170.set('fieldImages', {'dpt': '', 'niveau': '', 'alea': '', });
lyr_Zonesdalas_171.set('fieldImages', {'ID_ZONE': 'TextEdit', 'ID_GASPAR': 'TextEdit', 'DESCRIPT': 'TextEdit', 'CODERISQUE': 'TextEdit', 'NOMRISQUE': 'TextEdit', 'NIVALEA': 'TextEdit', 'NIVALEA_ST': 'TextEdit', 'TITRECARTE': 'TextEdit', 'DATECARTE': 'TextEdit', 'ID_MAP': 'TextEdit', });
lyr_Zonesrglementaires_172.set('fieldImages', {'id': 'TextEdit', 'id_map': 'TextEdit', 'id_zone': 'TextEdit', 'id_gaspar': 'TextEdit', 'nom': 'TextEdit', 'codezone': 'TextEdit', 'soumisalea': 'TextEdit', 'typereg': 'TextEdit', });
lyr_Ruissellement_173.set('fieldImages', {'id': 'TextEdit', 'id_map': 'TextEdit', 'id_zone': 'TextEdit', 'id_gaspar': 'TextEdit', 'nom': 'TextEdit', 'codezone': 'TextEdit', 'soumisalea': 'TextEdit', 'typereg': 'TextEdit', });
lyr_Secteurs_174.set('fieldImages', {'ALEA': 'Range', });
lyr_ICPE_175.set('fieldImages', {'code_aiot': 'TextEdit', 'x': 'TextEdit', 'y': 'TextEdit', 'code_epsg': 'TextEdit', 'nom_ets': 'TextEdit', 'num_dep': 'TextEdit', 'adresse': 'TextEdit', 'cd_insee': 'TextEdit', 'cd_postal': 'TextEdit', 'commune': 'TextEdit', 'code_naf': 'TextEdit', 'lib_naf': 'TextEdit', 'num_siret': 'TextEdit', 'cd_regime': 'TextEdit', 'lib_regime': 'TextEdit', 'seveso': 'TextEdit', 'lib_seveso': 'TextEdit', 'bovins': 'TextEdit', 'porcs': 'TextEdit', 'volailles': 'TextEdit', 'carriere': 'TextEdit', 'eolienne': 'TextEdit', 'industrie': 'TextEdit', 'ied': 'TextEdit', 'priorite_n': 'TextEdit', 'url_fiche': 'TextEdit', });
lyr_SitesBASOL_176.set('fieldImages', {'cd_metier': 'TextEdit', 'autre_id': 'TextEdit', 'nom_etab': 'TextEdit', 'nom_instr': 'TextEdit', 'code_siret': 'TextEdit', 'stat_instr': 'TextEdit', 'date_debut': 'DateTime', 'date_fin': 'DateTime', 'descript': 'TextEdit', 'code_insee': 'TextEdit', 'nom_com': 'TextEdit', 'x_wgs84': 'TextEdit', 'y_wgs84': 'TextEdit', 'code_dpt': 'TextEdit', 'nom_dpt': 'TextEdit', 'code_reg': 'TextEdit', 'nom_reg': 'TextEdit', 'act_nafv2': 'TextEdit', 'act_naf': 'TextEdit', 'act_icpe': 'TextEdit', 'act_nafv1': 'TextEdit', });
lyr_Sitespollus_177.set('fieldImages', {'cd_metier': '', 'autre_id': '', 'nom_ets': '', 'nom_site': '', 'code_siret': '', 'stat_instr': '', 'date_debut': '', 'date_fin': '', 'descript': '', 'code_insee': '', 'nom_com': '', 'x_wgs84': '', 'y_wgs84': '', 'code_dpt': '', 'nom_dpt': '', 'code_reg': '', 'nom_reg': '', 'act_nafv2': '', 'act_naf': '', 'act_icpe': '', 'act_nafv1': '', });
lyr_Zonesimpermables_178.set('fieldImages', {'Id': 'TextEdit', });
lyr_Remontesdenappes_179.set('fieldImages', {'CLASSE': 'TextEdit', 'FIAB_MNT': 'TextEdit', 'FIAB_ESO': 'TextEdit', 'FIAB_TOT': 'TextEdit', 'CLASSEFIAB': 'TextEdit', 'gridcode': 'TextEdit', });
lyr_ZNIEFFtype2_180.set('fieldImages', {'NOM_ZNIEFF': 'TextEdit', 'CODE_NATIO': 'TextEdit', 'CODE_REGIO': 'TextEdit', 'SURFACE_HA': 'TextEdit', 'SAISIE_LOG': 'TextEdit', 'DATE_DE_VA': 'DateTime', 'ORGANISME': 'TextEdit', 'INCLUSION': 'TextEdit', 'DEPARTEMEN': 'TextEdit', 'URLFICTECH': 'TextEdit', 'URLFICPUB': 'TextEdit', 'URLMETAD': 'TextEdit', });
lyr_ZNIEFFtype1_181.set('fieldImages', {'NOM_ZNIEFF': 'TextEdit', 'CODE_NATIO': 'TextEdit', 'CODE_REGIO': 'TextEdit', 'SURFACE_HA': 'TextEdit', 'SAISIE_LOG': 'TextEdit', 'DATE_DE_VA': 'DateTime', 'ORGANISME': 'TextEdit', 'INCLUSION': 'TextEdit', 'DEPARTEMEN': 'TextEdit', 'URLFICTECH': 'TextEdit', 'URLFICPUB': 'TextEdit', 'URLMETAD': 'TextEdit', });
lyr_Zoneshumides_182.set('fieldImages', {'LIBELLE': 'TextEdit', 'URLMETAD': 'TextEdit', });
lyr_Natura2000_183.set('fieldImages', {'SITECODE': '', 'SITENAME': '', });
lyr_Cimetire_184.set('fieldImages', {'ID': 'TextEdit', 'NATURE': 'TextEdit', 'NAT_DETAIL': 'TextEdit', 'TOPONYME': 'TextEdit', 'STATUT_TOP': 'TextEdit', 'IMPORTANCE': 'TextEdit', 'ETAT': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'SOURCE': 'TextEdit', 'ID_SOURCE': 'TextEdit', 'ACQU_PLANI': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'ACQU_ALTI': 'TextEdit', 'PREC_ALTI': 'TextEdit', });
lyr_Rservoir_185.set('fieldImages', {'ID': 'TextEdit', 'NATURE': 'TextEdit', 'ETAT': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'SOURCE': 'TextEdit', 'ID_SOURCE': 'TextEdit', 'ACQU_PLANI': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'ACQU_ALTI': 'TextEdit', 'PREC_ALTI': 'TextEdit', 'Z_MIN_SOL': 'TextEdit', 'Z_MIN_TOIT': 'TextEdit', 'HAUTEUR': 'TextEdit', 'Z_MAX_TOIT': 'TextEdit', 'Z_MAX_SOL': 'TextEdit', 'ORIGIN_BAT': 'TextEdit', 'VOLUME': 'TextEdit', });
lyr_Terraindesport_186.set('fieldImages', {'ID': 'TextEdit', 'NATURE': 'TextEdit', 'NAT_DETAIL': 'TextEdit', 'ETAT': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'SOURCE': 'TextEdit', 'ID_SOURCE': 'TextEdit', 'ACQU_PLANI': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'ACQU_ALTI': 'TextEdit', 'PREC_ALTI': 'TextEdit', });
lyr_Monument_187.set('fieldImages', {'ID': 'TextEdit', 'NATURE': 'TextEdit', 'USAGE1': 'TextEdit', 'USAGE2': 'TextEdit', 'LEGER': 'TextEdit', 'ETAT': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'SOURCE': 'TextEdit', 'ID_SOURCE': 'TextEdit', 'ACQU_PLANI': 'TextEdit', 'ACQU_ALTI': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'PREC_ALTI': 'TextEdit', 'NB_LOGTS': 'Range', 'NB_ETAGES': 'Range', 'MAT_MURS': 'TextEdit', 'MAT_TOITS': 'TextEdit', 'HAUTEUR': 'TextEdit', 'Z_MIN_SOL': 'TextEdit', 'Z_MIN_TOIT': 'TextEdit', 'Z_MAX_TOIT': 'TextEdit', 'Z_MAX_SOL': 'TextEdit', 'ORIGIN_BAT': 'TextEdit', 'APP_FF': 'TextEdit', 'IDS_RNB': 'TextEdit', });
lyr_Indiffrenci_188.set('fieldImages', {'ID': 'TextEdit', 'NATURE': 'TextEdit', 'USAGE1': 'TextEdit', 'USAGE2': 'TextEdit', 'LEGER': 'TextEdit', 'ETAT': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'SOURCE': 'TextEdit', 'ID_SOURCE': 'TextEdit', 'ACQU_PLANI': 'TextEdit', 'ACQU_ALTI': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'PREC_ALTI': 'TextEdit', 'NB_LOGTS': 'Range', 'NB_ETAGES': 'Range', 'MAT_MURS': 'TextEdit', 'MAT_TOITS': 'TextEdit', 'HAUTEUR': 'TextEdit', 'Z_MIN_SOL': 'TextEdit', 'Z_MIN_TOIT': 'TextEdit', 'Z_MAX_TOIT': 'TextEdit', 'Z_MAX_SOL': 'TextEdit', 'ORIGIN_BAT': 'TextEdit', 'APP_FF': 'TextEdit', 'IDS_RNB': 'TextEdit', });
lyr_Industrielagricoleoucommercial_189.set('fieldImages', {'ID': 'TextEdit', 'NATURE': 'TextEdit', 'USAGE1': 'TextEdit', 'USAGE2': 'TextEdit', 'LEGER': 'TextEdit', 'ETAT': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'SOURCE': 'TextEdit', 'ID_SOURCE': 'TextEdit', 'ACQU_PLANI': 'TextEdit', 'ACQU_ALTI': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'PREC_ALTI': 'TextEdit', 'NB_LOGTS': 'Range', 'NB_ETAGES': 'Range', 'MAT_MURS': 'TextEdit', 'MAT_TOITS': 'TextEdit', 'HAUTEUR': 'TextEdit', 'Z_MIN_SOL': 'TextEdit', 'Z_MIN_TOIT': 'TextEdit', 'Z_MAX_TOIT': 'TextEdit', 'Z_MAX_SOL': 'TextEdit', 'ORIGIN_BAT': 'TextEdit', 'APP_FF': 'TextEdit', 'IDS_RNB': 'TextEdit', });
lyr_Constructionsponctuelles_190.set('fieldImages', {'ID': 'TextEdit', 'NATURE': 'TextEdit', 'NAT_DETAIL': 'TextEdit', 'TOPONYME': 'TextEdit', 'STATUT_TOP': 'TextEdit', 'IMPORTANCE': 'TextEdit', 'ETAT': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'SOURCE': 'TextEdit', 'ID_SOURCE': 'TextEdit', 'ACQU_PLANI': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'ACQU_ALTI': 'TextEdit', 'PREC_ALTI': 'TextEdit', 'HAUTEUR': 'TextEdit', });
lyr_Pylne_191.set('fieldImages', {'ID': 'TextEdit', 'ETAT': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'SOURCE': 'TextEdit', 'ID_SOURCE': 'TextEdit', 'ACQU_PLANI': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'ACQU_ALTI': 'TextEdit', 'PREC_ALTI': 'TextEdit', 'HAUTEUR': 'TextEdit', });
lyr_CCdes4Rivires_192.set('fieldImages', {'ID': 'TextEdit', 'CODE_SIREN': 'TextEdit', 'NATURE': 'TextEdit', 'NOM': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'ID_AUT_ADM': 'TextEdit', });
lyr_CCBrayEawy_193.set('fieldImages', {'ID': 'TextEdit', 'CODE_SIREN': 'TextEdit', 'NATURE': 'TextEdit', 'NOM': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'ID_AUT_ADM': 'TextEdit', });
lyr_CCdeLondinieres_194.set('fieldImages', {'ID': 'TextEdit', 'CODE_SIREN': 'TextEdit', 'NATURE': 'TextEdit', 'NOM': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'ID_AUT_ADM': 'TextEdit', });
lyr_Parcellescadastrales_195.set('fieldImages', {'id': 'TextEdit', 'commune': 'TextEdit', 'prefixe': 'TextEdit', 'section': 'TextEdit', 'numero': 'TextEdit', 'contenance': 'TextEdit', 'created': 'DateTime', 'updated': 'DateTime', 'layer': 'TextEdit', 'path': 'TextEdit', });
lyr_Communesassociesoudlgues_196.set('fieldImages', {'ID': 'TextEdit', 'INSEE_CAD': 'TextEdit', 'INSEE_COM': 'TextEdit', 'NATURE': 'TextEdit', 'NOM': 'TextEdit', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'CODE_POST': 'TextEdit', 'ID_CH_LIEU': 'TextEdit', 'ID_AUT_ADM': 'TextEdit', 'POPULATION': 'Range', 'CODE_SIREN': 'TextEdit', });
lyr_CommunesadhrentesADS_197.set('fieldImages', {'ID': 'TextEdit', 'INSEE_COM': 'TextEdit', 'INSEE_ARR': 'TextEdit', 'INSEE_COL': 'TextEdit', 'INSEE_DEP': 'TextEdit', 'INSEE_REG': 'TextEdit', 'POPULATION': 'Range', 'SURFACE_HA': 'Range', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'CODE_POST': 'TextEdit', 'NOM': 'TextEdit', 'CL_ARROND': 'TextEdit', 'CL_COLLTER': 'TextEdit', 'CL_DEPART': 'TextEdit', 'CL_REGION': 'TextEdit', 'CAPITALE': 'TextEdit', 'DATE_RCT': 'DateTime', 'RECENSEUR': 'TextEdit', 'SIREN_EPCI': 'TextEdit', 'ID_CH_LIEU': 'TextEdit', 'ID_AUT_ADM': 'TextEdit', 'CODE_SIREN': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', });
lyr_Communes_198.set('fieldImages', {'ID': 'TextEdit', 'INSEE_COM': 'TextEdit', 'INSEE_ARR': 'TextEdit', 'INSEE_COL': 'TextEdit', 'INSEE_DEP': 'TextEdit', 'INSEE_REG': 'TextEdit', 'POPULATION': 'Range', 'SURFACE_HA': 'Range', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'CODE_POST': 'TextEdit', 'NOM': 'TextEdit', 'CL_ARROND': 'TextEdit', 'CL_COLLTER': 'TextEdit', 'CL_DEPART': 'TextEdit', 'CL_REGION': 'TextEdit', 'CAPITALE': 'TextEdit', 'DATE_RCT': 'DateTime', 'RECENSEUR': 'TextEdit', 'SIREN_EPCI': 'TextEdit', 'ID_CH_LIEU': 'TextEdit', 'ID_AUT_ADM': 'TextEdit', 'CODE_SIREN': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', });
lyr_Nomdescommunes_199.set('fieldImages', {'ID': 'TextEdit', 'INSEE_COM': 'TextEdit', 'INSEE_ARR': 'TextEdit', 'INSEE_COL': 'TextEdit', 'INSEE_DEP': 'TextEdit', 'INSEE_REG': 'TextEdit', 'POPULATION': 'Range', 'SURFACE_HA': 'Range', 'DATE_CREAT': 'TextEdit', 'DATE_MAJ': 'TextEdit', 'DATE_APP': 'DateTime', 'DATE_CONF': 'DateTime', 'CODE_POST': 'TextEdit', 'NOM': 'TextEdit', 'CL_ARROND': 'TextEdit', 'CL_COLLTER': 'TextEdit', 'CL_DEPART': 'TextEdit', 'CL_REGION': 'TextEdit', 'CAPITALE': 'TextEdit', 'DATE_RCT': 'DateTime', 'RECENSEUR': 'TextEdit', 'SIREN_EPCI': 'TextEdit', 'ID_CH_LIEU': 'TextEdit', 'ID_AUT_ADM': 'TextEdit', 'CODE_SIREN': 'TextEdit', 'layer': '', 'path': '', });
...
lyr_Sitesauxabords_145.set('fieldLabels', {'idTigre': 'hidden field', 'idApp': 'hidden field', 'appTigre': 'hidden field', 'type': 'hidden field', 'parcelle': 'hidden field', 'appelation': 'inline label - visible with data', 'categorie': 'hidden field', 'localisati': 'hidden field', 'ressource': 'hidden field', 'evenement': 'hidden field', 'legende': 'hidden field', 'precision': 'hidden field', 'statut': 'hidden field', 'maj': 'hidden field', 'region': 'hidden field', 'departemen': 'hidden field', 'commune': 'hidden field', });
lyr_SUPMH_146.set('fieldLabels', {'idTigre': 'hidden field', 'idApp': 'hidden field', 'appTigre': 'hidden field', 'type': 'hidden field', 'parcelle': 'hidden field', 'appelation': 'inline label - always visible', 'categorie': 'hidden field', 'localisati': 'hidden field', 'ressource': 'hidden field', 'evenement': 'hidden field', 'legende': 'hidden field', 'precision': 'hidden field', 'statut': 'hidden field', 'maj': 'hidden field', 'region': 'hidden field', 'departemen': 'hidden field', 'commune': 'hidden field', });
lyr_SPR_147.set('fieldLabels', {'idTigre': 'hidden field', 'idApp': 'hidden field', 'appTigre': 'hidden field', 'type': 'hidden field', 'parcelle': 'hidden field', 'appelation': 'inline label - visible with data', 'categorie': 'hidden field', 'localisati': 'hidden field', 'ressource': 'hidden field', 'evenement': 'hidden field', 'legende': 'hidden field', 'precision': 'hidden field', 'statut': 'hidden field', 'maj': 'hidden field', 'region': 'hidden field', 'departemen': 'hidden field', 'commune': 'hidden field', });
lyr_Sitesclasss_148.set('fieldLabels', {'idsite': 'hidden field', 'idintgest': 'hidden field', 'dep': 'hidden field', 'nomsite': 'inline label - visible with data', 'type': 'hidden field', 'descriptio': 'hidden field', 'nature': 'hidden field', 'datedecis': 'hidden field', 'datedecisr': 'hidden field', 'surfoffic': 'hidden field', 'echnum': 'hidden field', 'precision': 'hidden field', 'srcgeogen': 'hidden field', 'datesrcgen': 'hidden field', 'surfcalc': 'hidden field', 'surfmer': 'hidden field', 'urlfiche': 'hidden field', 'urltxtrgl': 'hidden field', 'urlcarte': 'hidden field', 'urlcartec': 'hidden field', 'urlweb': 'hidden field', 'urlcarmen': 'hidden field', });
lyr_Sitesinscrits_149.set('fieldLabels', {'idsite': 'hidden field', 'idintgest': 'hidden field', 'dep': 'hidden field', 'nomsite': 'inline label - visible with data', 'type': 'hidden field', 'descriptio': 'hidden field', 'nature': 'hidden field', 'datedecis': 'hidden field', 'datedecisr': 'hidden field', 'surfoffic': 'hidden field', 'echnum': 'hidden field', 'precision': 'hidden field', 'srcgeogen': 'hidden field', 'datesrcgen': 'hidden field', 'surfcalc': 'hidden field', 'surfmer': 'hidden field', 'urlfiche': 'hidden field', 'urltxtrgl': 'hidden field', 'urlcarte': 'hidden field', 'urlcartec': 'hidden field', 'urlweb': 'hidden field', 'urlcarmen': 'hidden field', });
lyr_Immeubles_150.set('fieldLabels', {'idTigre': 'hidden field', 'idApp': 'hidden field', 'appTigre': 'hidden field', 'type': 'hidden field', 'parcelle': 'hidden field', 'appelation': 'inline label - visible with data', 'categorie': 'inline label - visible with data', 'localisati': 'hidden field', 'ressource': 'hidden field', 'evenement': 'hidden field', 'legende': 'hidden field', 'precision': 'hidden field', 'statut': 'hidden field', 'maj': 'hidden field', 'region': 'hidden field', 'departemen': 'hidden field', 'commune': 'hidden field', });
lyr_ZPPA_151.set('fieldLabels', {'EA_NATCODE': 'inline label - visible with data', 'COMMUNE_PP': 'hidden field', 'NUMORDRE': 'hidden field', 'NUMERO': 'inline label - visible with data', 'NUMERO_DRA': 'hidden field', 'NOMUSUEL': 'inline label - visible with data', 'LIEU_IGN': 'hidden field', 'LIEU_CADAS': 'hidden field', 'VESTIGES': 'hidden field', 'NATURE_VES': 'hidden field', 'CHRONO_DEB': 'hidden field', 'CHRONO_FIN': 'hidden field', 'CHRONO_FOU': 'hidden field', 'CHRONO_DOU': 'hidden field', 'CHRONO_PER': 'hidden field', 'COMMENT_CH': 'hidden field', 'NUMERIQUE_': 'hidden field', 'NUMERIQU_1': 'hidden field', 'CHRONO_D_1': 'hidden field', 'X_SAISI': 'hidden field', 'Y_SAISI': 'hidden field', 'SURFACE': 'hidden field', 'PARCELLES': 'hidden field', 'INVENTEUR': 'hidden field', 'ANNEE_DECO': 'inline label - visible with data', 'X_DEGRE': 'hidden field', 'Y_DEGRE': 'hidden field', 'EMPRISE': 'hidden field', 'GEOREFEREN': 'hidden field', 'GEOMETRIE': 'hidden field', });
lyr_ZPPAcentrodes_152.set('fieldLabels', {'EA_NATCODE': 'hidden field', 'COMMUNE_PP': 'hidden field', 'NUMORDRE': 'hidden field', 'NUMERO': 'hidden field', 'NUMERO_DRA': 'hidden field', 'NOMUSUEL': 'hidden field', 'LIEU_IGN': 'hidden field', 'LIEU_CADAS': 'hidden field', 'VESTIGES': 'hidden field', 'NATURE_VES': 'hidden field', 'CHRONO_DEB': 'hidden field', 'CHRONO_FIN': 'hidden field', 'CHRONO_FOU': 'hidden field', 'CHRONO_DOU': 'hidden field', 'CHRONO_PER': 'hidden field', 'COMMENT_CH': 'hidden field', 'NUMERIQUE_': 'hidden field', 'NUMERIQU_1': 'hidden field', 'CHRONO_D_1': 'hidden field', 'X_SAISI': 'hidden field', 'Y_SAISI': 'hidden field', 'SURFACE': 'hidden field', 'PARCELLES': 'hidden field', 'INVENTEUR': 'hidden field', 'ANNEE_DECO': 'hidden field', 'X_DEGRE': 'hidden field', 'Y_DEGRE': 'hidden field', 'EMPRISE': 'hidden field', 'GEOREFEREN': 'hidden field', 'GEOMETRIE': 'hidden field', });
lyr_RoutesconcdesTypeC_153.set('fieldLabels', {'IDZONBRUIT': 'hidden field', 'IDCBS': 'hidden field', 'ANNEE': 'hidden field', 'CODEDEPT': 'hidden field', 'TYPETERR': 'hidden field', 'PRODUCTEUR': 'hidden field', 'CODINFRA': 'hidden field', 'TYPESOURCE': 'hidden field', 'CBSTYPE': 'hidden field', 'ZONEDEF': 'hidden field', 'LEGENDE': 'inline label - visible with data', 'VALIDEFIN': 'hidden field', 'LEG_SANEF': 'hidden field', });
lyr_RoutesconcdesTypeA_154.set('fieldLabels', {'IDZONBRUIT': 'hidden field', 'IDCBS': 'hidden field', 'ANNEE': 'hidden field', 'CODEDEPT': 'hidden field', 'TYPETERR': 'hidden field', 'PRODUCTEUR': 'hidden field', 'CODINFRA': 'hidden field', 'TYPESOURCE': 'hidden field', 'CBSTYPE': 'hidden field', 'ZONEDEF': 'hidden field', 'LEGENDE': 'inline label - visible with data', 'VALIDEDEB': 'hidden field', 'VALIDEFIN': 'hidden field', 'LEGENDPROD': 'hidden field', });
lyr_RoutesTypeC_155.set('fieldLabels', {'IDZONBRUIT': 'hidden field', 'IDCBS': 'hidden field', 'UUEID': 'hidden field', 'ANNEE': 'hidden field', 'CODEDEPT': 'hidden field', 'TYPETERR': 'hidden field', 'PRODUCTEUR': 'hidden field', 'CODINFRA': 'hidden field', 'TYPESOURCE': 'hidden field', 'CBSTYPE': 'hidden field', 'ZONEDEF': 'hidden field', 'LEGENDE': 'inline label - visible with data', 'INDICETYPE': 'hidden field', 'VALIDEDEB': 'hidden field', 'VALIDEFIN': 'hidden field', });
lyr_RoutesTypeA_156.set('fieldLabels', {'IDZONBRUIT': 'hidden field', 'IDCBS': 'hidden field', 'UUEID': 'hidden field', 'ANNEE': 'hidden field', 'CODEDEPT': 'hidden field', 'TYPETERR': 'hidden field', 'PRODUCTEUR': 'hidden field', 'CODINFRA': 'hidden field', 'TYPESOURCE': 'hidden field', 'CBSTYPE': 'hidden field', 'ZONEDEF': 'hidden field', 'LEGENDE': 'inline label - visible with data', 'INDICETYPE': 'hidden field', 'VALIDEDEB': 'hidden field', 'VALIDEFIN': 'hidden field', });
lyr_Canalisationshydrocarbures_157.set('fieldLabels', {'ID': 'hidden field', 'NATURE': 'hidden field', 'POS_SOL': 'hidden field', 'ETAT': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', 'ACQU_PLANI': 'hidden field', 'PREC_PLANI': 'hidden field', 'ACQU_ALTI': 'hidden field', 'PREC_ALTI': 'hidden field', });
lyr_CanalisationsgazGRT_158.set('fieldLabels', {'object_id': 'hidden field', 'nom_region': 'hidden field', 'departemen': 'hidden field', });
lyr_CanalisationsgazGRDF_159.set('fieldLabels', {'etat_serv': 'hidden field', 'insee_comm': 'hidden field', 'commune_ad': 'hidden field', 'code_depar': 'hidden field', 'departemen': 'hidden field', 'region_adm': 'hidden field', 'ID': 'hidden field', 'INSEE_COM': 'hidden field', 'INSEE_ARR': 'hidden field', 'INSEE_COL': 'hidden field', 'INSEE_DEP': 'hidden field', 'INSEE_REG': 'hidden field', 'POPULATION': 'hidden field', 'SURFACE_HA': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'CODE_POST': 'hidden field', 'NOM': 'hidden field', 'CL_ARROND': 'hidden field', 'CL_COLLTER': 'hidden field', 'CL_DEPART': 'hidden field', 'CL_REGION': 'hidden field', 'CAPITALE': 'hidden field', 'DATE_RCT': 'hidden field', 'RECENSEUR': 'hidden field', 'SIREN_EPCI': 'hidden field', 'ID_CH_LIEU': 'hidden field', 'ID_AUT_ADM': 'hidden field', 'CODE_SIREN': 'hidden field', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_LignesbassetensionsouterrainesENEDIS_160.set('fieldLabels', {'code_commu': 'hidden field', 'nom_commun': 'hidden field', 'code_epci': 'hidden field', 'nom_epci': 'hidden field', 'code_depar': 'hidden field', 'nom_depart': 'hidden field', 'code_regio': 'hidden field', 'nom_region': 'hidden field', });
lyr_LignesbassetensionariennesENEDIS_161.set('fieldLabels', {'code_commu': 'hidden field', 'nom_commun': 'hidden field', 'code_epci': 'hidden field', 'nom_epci': 'hidden field', 'code_depar': 'hidden field', 'nom_depart': 'hidden field', 'code_regio': 'hidden field', 'nom_region': 'hidden field', });
lyr_LigneshautetensionsouterrainesENEDIS_162.set('fieldLabels', {'code_commu': 'hidden field', 'nom_commun': 'hidden field', 'code_epci': 'hidden field', 'nom_epci': 'hidden field', 'code_depar': 'hidden field', 'nom_depart': 'hidden field', 'code_regio': 'hidden field', 'nom_region': 'hidden field', });
lyr_LigneshautetensionariennesENEDIS_163.set('fieldLabels', {'code_commu': 'hidden field', 'nom_commun': 'hidden field', 'code_epci': 'hidden field', 'nom_epci': 'hidden field', 'code_depar': 'hidden field', 'nom_depart': 'hidden field', 'code_regio': 'hidden field', 'nom_region': 'hidden field', });
lyr_LigneshautetensionRTE_164.set('fieldLabels', {'ID': 'hidden field', 'VOLTAGE': 'inline label - visible with data', 'ETAT': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', 'ACQU_PLANI': 'hidden field', 'PREC_PLANI': 'hidden field', 'ACQU_ALTI': 'hidden field', 'PREC_ALTI': 'hidden field', });
lyr_Postesdetransformation_165.set('fieldLabels', {'ID': 'hidden field', 'TOPONYME': 'inline label - visible with data', 'STATUT_TOP': 'hidden field', 'IMPORTANCE': 'hidden field', 'ETAT': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', 'ACQU_PLANI': 'hidden field', 'PREC_PLANI': 'hidden field', 'ACQU_ALTI': 'hidden field', 'PREC_ALTI': 'hidden field', });
lyr_Itinraireautre_166.set('fieldLabels', {'ID': 'hidden field', 'NATURE': 'inline label - visible with data', 'NAT_DETAIL': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', });
...
lyr_RoutesdeGrandeCirculation_168.set('fieldLabels', {'objectid': 'hidden field', 'axe': 'hidden field', 'cumuld': 'hidden field', 'cumulf': 'hidden field', 'plod': 'hidden field', 'absd': 'hidden field', 'plof': 'hidden field', 'absf': 'hidden field', 'xd': 'hidden field', 'yd': 'hidden field', 'zd': 'hidden field', 'xf': 'hidden field', 'yf': 'hidden field', 'zf': 'hidden field', 'cote': 'hidden field', 'emplacemen': 'hidden field', 'voie': 'hidden field', 'distance': 'hidden field', 'accrochage': 'hidden field', 'objetid': 'hidden field', 'longueur': 'hidden field', 'releve_xy': 'hidden field', 'parent_id': 'hidden field', 'validation': 'hidden field', 'status': 'hidden field', 'link_id': 'hidden field', 'import': 'hidden field', 'user_creat': 'hidden field', 'date_creat': 'hidden field', 'user_modif': 'hidden field', 'date_modif': 'hidden field', 'territoire': 'hidden field', 'daterefere': 'hidden field', 'chaussee': 'hidden field', 'id_prj': 'hidden field', 'date_grde_': 'hidden field', 'grande_cir': 'hidden field', 'SHAPE_Leng': 'hidden field', });
lyr_Routesnumrotesounommes_169.set('fieldLabels', {'ID': 'hidden field', 'TYPE_ROUTE': 'hidden field', 'NUMERO': 'hidden field', 'TOPONYME': 'inline label - visible with data', 'STATUT_TOP': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', 'GESTION': 'hidden field', });
lyr_Niveaudurisque_170.set('fieldLabels', {'dpt': 'hidden field', 'niveau': 'inline label - visible with data', 'alea': 'hidden field', });
lyr_Zonesdalas_171.set('fieldLabels', {'ID_ZONE': 'hidden field', 'ID_GASPAR': 'hidden field', 'DESCRIPT': 'hidden field', 'CODERISQUE': 'hidden field', 'NOMRISQUE': 'hidden field', 'NIVALEA': 'inline label - visible with data', 'NIVALEA_ST': 'hidden field', 'TITRECARTE': 'hidden field', 'DATECARTE': 'hidden field', 'ID_MAP': 'hidden field', });
lyr_Zonesrglementaires_172.set('fieldLabels', {'id': 'hidden field', 'id_map': 'hidden field', 'id_zone': 'hidden field', 'id_gaspar': 'hidden field', 'nom': 'inline label - visible with data', 'codezone': 'hidden field', 'soumisalea': 'hidden field', 'typereg': 'hidden field', });
lyr_Ruissellement_173.set('fieldLabels', {'id': 'hidden field', 'id_map': 'hidden field', 'id_zone': 'hidden field', 'id_gaspar': 'hidden field', 'nom': 'hidden field', 'codezone': 'hidden field', 'soumisalea': 'hidden field', 'typereg': 'hidden field', });
lyr_Secteurs_174.set('fieldLabels', {'ALEA': 'inline label - visible with data', });
lyr_ICPE_175.set('fieldLabels', {'code_aiot': 'hidden field', 'x': 'hidden field', 'y': 'hidden field', 'code_epsg': 'hidden field', 'nom_ets': 'inline label - visible with data', 'num_dep': 'hidden field', 'adresse': 'hidden field', 'cd_insee': 'hidden field', 'cd_postal': 'hidden field', 'commune': 'hidden field', 'code_naf': 'hidden field', 'lib_naf': 'hidden field', 'num_siret': 'hidden field', 'cd_regime': 'hidden field', 'lib_regime': 'hidden field', 'seveso': 'hidden field', 'lib_seveso': 'inline label - visible with data', 'bovins': 'hidden field', 'porcs': 'hidden field', 'volailles': 'hidden field', 'carriere': 'hidden field', 'eolienne': 'hidden field', 'industrie': 'hidden field', 'ied': 'hidden field', 'priorite_n': 'hidden field', 'url_fiche': 'hidden field', });
lyr_SitesBASOL_176.set('fieldLabels', {'cd_metier': 'hidden field', 'autre_id': 'hidden field', 'nom_etab': 'inline label - visible with data', 'nom_instr': 'hidden field', 'code_siret': 'hidden field', 'stat_instr': 'hidden field', 'date_debut': 'hidden field', 'date_fin': 'hidden field', 'descript': 'hidden field', 'code_insee': 'hidden field', 'nom_com': 'hidden field', 'x_wgs84': 'hidden field', 'y_wgs84': 'hidden field', 'code_dpt': 'hidden field', 'nom_dpt': 'hidden field', 'code_reg': 'hidden field', 'nom_reg': 'hidden field', 'act_nafv2': 'hidden field', 'act_naf': 'hidden field', 'act_icpe': 'hidden field', 'act_nafv1': 'hidden field', });
lyr_Sitespollus_177.set('fieldLabels', {'cd_metier': 'hidden field', 'autre_id': 'hidden field', 'nom_ets': 'inline label - visible with data', 'nom_site': 'hidden field', 'code_siret': 'hidden field', 'stat_instr': 'hidden field', 'date_debut': 'hidden field', 'date_fin': 'hidden field', 'descript': 'hidden field', 'code_insee': 'hidden field', 'nom_com': 'hidden field', 'x_wgs84': 'hidden field', 'y_wgs84': 'hidden field', 'code_dpt': 'hidden field', 'nom_dpt': 'hidden field', 'code_reg': 'hidden field', 'nom_reg': 'hidden field', 'act_nafv2': 'hidden field', 'act_naf': 'hidden field', 'act_icpe': 'hidden field', 'act_nafv1': 'hidden field', });
lyr_Zonesimpermables_178.set('fieldLabels', {'Id': 'hidden field', });
lyr_Remontesdenappes_179.set('fieldLabels', {'CLASSE': 'inline label - visible with data', 'FIAB_MNT': 'hidden field', 'FIAB_ESO': 'hidden field', 'FIAB_TOT': 'hidden field', 'CLASSEFIAB': 'hidden field', 'gridcode': 'hidden field', });
lyr_ZNIEFFtype2_180.set('fieldLabels', {'NOM_ZNIEFF': 'hidden field', 'CODE_NATIO': 'hidden field', 'CODE_REGIO': 'hidden field', 'SURFACE_HA': 'hidden field', 'SAISIE_LOG': 'hidden field', 'DATE_DE_VA': 'hidden field', 'ORGANISME': 'hidden field', 'INCLUSION': 'hidden field', 'DEPARTEMEN': 'hidden field', 'URLFICTECH': 'hidden field', 'URLFICPUB': 'hidden field', 'URLMETAD': 'hidden field', });
lyr_ZNIEFFtype1_181.set('fieldLabels', {'NOM_ZNIEFF': 'hidden field', 'CODE_NATIO': 'hidden field', 'CODE_REGIO': 'hidden field', 'SURFACE_HA': 'hidden field', 'SAISIE_LOG': 'hidden field', 'DATE_DE_VA': 'hidden field', 'ORGANISME': 'hidden field', 'INCLUSION': 'hidden field', 'DEPARTEMEN': 'hidden field', 'URLFICTECH': 'hidden field', 'URLFICPUB': 'hidden field', 'URLMETAD': 'hidden field', });
lyr_Zoneshumides_182.set('fieldLabels', {'LIBELLE': 'hidden field', 'URLMETAD': 'hidden field', });
lyr_Natura2000_183.set('fieldLabels', {'SITECODE': 'hidden field', 'SITENAME': 'hidden field', });
lyr_Cimetire_184.set('fieldLabels', {'ID': 'hidden field', 'NATURE': 'inline label - visible with data', 'NAT_DETAIL': 'hidden field', 'TOPONYME': 'inline label - visible with data', 'STATUT_TOP': 'hidden field', 'IMPORTANCE': 'hidden field', 'ETAT': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', 'ACQU_PLANI': 'hidden field', 'PREC_PLANI': 'hidden field', 'ACQU_ALTI': 'hidden field', 'PREC_ALTI': 'hidden field', });
lyr_Rservoir_185.set('fieldLabels', {'ID': 'hidden field', 'NATURE': 'inline label - visible with data', 'ETAT': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', 'ACQU_PLANI': 'hidden field', 'PREC_PLANI': 'hidden field', 'ACQU_ALTI': 'hidden field', 'PREC_ALTI': 'hidden field', 'Z_MIN_SOL': 'hidden field', 'Z_MIN_TOIT': 'hidden field', 'HAUTEUR': 'hidden field', 'Z_MAX_TOIT': 'hidden field', 'Z_MAX_SOL': 'hidden field', 'ORIGIN_BAT': 'hidden field', 'VOLUME': 'inline label - visible with data', });
lyr_Terraindesport_186.set('fieldLabels', {'ID': 'hidden field', 'NATURE': 'inline label - visible with data', 'NAT_DETAIL': 'hidden field', 'ETAT': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', 'ACQU_PLANI': 'hidden field', 'PREC_PLANI': 'hidden field', 'ACQU_ALTI': 'hidden field', 'PREC_ALTI': 'hidden field', });
lyr_Monument_187.set('fieldLabels', {'ID': 'hidden field', 'NATURE': 'inline label - visible with data', 'USAGE1': 'header label - always visible', 'USAGE2': 'hidden field', 'LEGER': 'hidden field', 'ETAT': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', 'ACQU_PLANI': 'hidden field', 'ACQU_ALTI': 'hidden field', 'PREC_PLANI': 'hidden field', 'PREC_ALTI': 'hidden field', 'NB_LOGTS': 'hidden field', 'NB_ETAGES': 'hidden field', 'MAT_MURS': 'hidden field', 'MAT_TOITS': 'hidden field', 'HAUTEUR': 'header label - always visible', 'Z_MIN_SOL': 'hidden field', 'Z_MIN_TOIT': 'hidden field', 'Z_MAX_TOIT': 'hidden field', 'Z_MAX_SOL': 'hidden field', 'ORIGIN_BAT': 'hidden field', 'APP_FF': 'hidden field', 'IDS_RNB': 'hidden field', });
lyr_Indiffrenci_188.set('fieldLabels', {'ID': 'hidden field', 'NATURE': 'inline label - visible with data', 'USAGE1': 'inline label - visible with data', 'USAGE2': 'hidden field', 'LEGER': 'hidden field', 'ETAT': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', 'ACQU_PLANI': 'hidden field', 'ACQU_ALTI': 'hidden field', 'PREC_PLANI': 'hidden field', 'PREC_ALTI': 'hidden field', 'NB_LOGTS': 'inline label - visible with data', 'NB_ETAGES': 'inline label - visible with data', 'MAT_MURS': 'inline label - visible with data', 'MAT_TOITS': 'inline label - visible with data', 'HAUTEUR': 'hidden field', 'Z_MIN_SOL': 'hidden field', 'Z_MIN_TOIT': 'hidden field', 'Z_MAX_TOIT': 'hidden field', 'Z_MAX_SOL': 'hidden field', 'ORIGIN_BAT': 'hidden field', 'APP_FF': 'hidden field', 'IDS_RNB': 'hidden field', });
lyr_Industrielagricoleoucommercial_189.set('fieldLabels', {'ID': 'hidden field', 'NATURE': 'inline label - visible with data', 'USAGE1': 'inline label - visible with data', 'USAGE2': 'hidden field', 'LEGER': 'hidden field', 'ETAT': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', 'ACQU_PLANI': 'hidden field', 'ACQU_ALTI': 'hidden field', 'PREC_PLANI': 'hidden field', 'PREC_ALTI': 'hidden field', 'NB_LOGTS': 'hidden field', 'NB_ETAGES': 'inline label - visible with data', 'MAT_MURS': 'hidden field', 'MAT_TOITS': 'inline label - visible with data', 'HAUTEUR': 'inline label - visible with data', 'Z_MIN_SOL': 'hidden field', 'Z_MIN_TOIT': 'hidden field', 'Z_MAX_TOIT': 'hidden field', 'Z_MAX_SOL': 'hidden field', 'ORIGIN_BAT': 'hidden field', 'APP_FF': 'hidden field', 'IDS_RNB': 'hidden field', });
lyr_Constructionsponctuelles_190.set('fieldLabels', {'ID': 'hidden field', 'NATURE': 'inline label - visible with data', 'NAT_DETAIL': 'hidden field', 'TOPONYME': 'inline label - visible with data', 'STATUT_TOP': 'hidden field', 'IMPORTANCE': 'hidden field', 'ETAT': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', 'ACQU_PLANI': 'hidden field', 'PREC_PLANI': 'hidden field', 'ACQU_ALTI': 'hidden field', 'PREC_ALTI': 'hidden field', 'HAUTEUR': 'hidden field', });
lyr_Pylne_191.set('fieldLabels', {'ID': 'hidden field', 'ETAT': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'SOURCE': 'hidden field', 'ID_SOURCE': 'hidden field', 'ACQU_PLANI': 'hidden field', 'PREC_PLANI': 'hidden field', 'ACQU_ALTI': 'hidden field', 'PREC_ALTI': 'hidden field', 'HAUTEUR': 'inline label - visible with data', });
lyr_CCdes4Rivires_192.set('fieldLabels', {'ID': 'hidden field', 'CODE_SIREN': 'hidden field', 'NATURE': 'hidden field', 'NOM': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'ID_AUT_ADM': 'hidden field', });
lyr_CCBrayEawy_193.set('fieldLabels', {'ID': 'hidden field', 'CODE_SIREN': 'hidden field', 'NATURE': 'hidden field', 'NOM': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'ID_AUT_ADM': 'hidden field', });
lyr_CCdeLondinieres_194.set('fieldLabels', {'ID': 'hidden field', 'CODE_SIREN': 'hidden field', 'NATURE': 'hidden field', 'NOM': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'ID_AUT_ADM': 'hidden field', });
lyr_Parcellescadastrales_195.set('fieldLabels', {'id': 'hidden field', 'commune': 'hidden field', 'prefixe': 'hidden field', 'section': 'inline label - visible with data', 'numero': 'inline label - visible with data', 'contenance': 'hidden field', 'created': 'hidden field', 'updated': 'hidden field', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_Communesassociesoudlgues_196.set('fieldLabels', {'ID': 'hidden field', 'INSEE_CAD': 'hidden field', 'INSEE_COM': 'hidden field', 'NATURE': 'hidden field', 'NOM': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'CODE_POST': 'hidden field', 'ID_CH_LIEU': 'hidden field', 'ID_AUT_ADM': 'hidden field', 'POPULATION': 'hidden field', 'CODE_SIREN': 'hidden field', });
lyr_CommunesadhrentesADS_197.set('fieldLabels', {'ID': 'hidden field', 'INSEE_COM': 'hidden field', 'INSEE_ARR': 'hidden field', 'INSEE_COL': 'hidden field', 'INSEE_DEP': 'hidden field', 'INSEE_REG': 'hidden field', 'POPULATION': 'hidden field', 'SURFACE_HA': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'CODE_POST': 'hidden field', 'NOM': 'hidden field', 'CL_ARROND': 'hidden field', 'CL_COLLTER': 'hidden field', 'CL_DEPART': 'hidden field', 'CL_REGION': 'hidden field', 'CAPITALE': 'hidden field', 'DATE_RCT': 'hidden field', 'RECENSEUR': 'hidden field', 'SIREN_EPCI': 'hidden field', 'ID_CH_LIEU': 'hidden field', 'ID_AUT_ADM': 'hidden field', 'CODE_SIREN': 'hidden field', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_Communes_198.set('fieldLabels', {'ID': 'hidden field', 'INSEE_COM': 'hidden field', 'INSEE_ARR': 'hidden field', 'INSEE_COL': 'hidden field', 'INSEE_DEP': 'hidden field', 'INSEE_REG': 'hidden field', 'POPULATION': 'hidden field', 'SURFACE_HA': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'CODE_POST': 'hidden field', 'NOM': 'inline label - visible with data', 'CL_ARROND': 'hidden field', 'CL_COLLTER': 'hidden field', 'CL_DEPART': 'hidden field', 'CL_REGION': 'hidden field', 'CAPITALE': 'hidden field', 'DATE_RCT': 'hidden field', 'RECENSEUR': 'hidden field', 'SIREN_EPCI': 'hidden field', 'ID_CH_LIEU': 'hidden field', 'ID_AUT_ADM': 'hidden field', 'CODE_SIREN': 'hidden field', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_Nomdescommunes_199.set('fieldLabels', {'ID': 'hidden field', 'INSEE_COM': 'hidden field', 'INSEE_ARR': 'hidden field', 'INSEE_COL': 'hidden field', 'INSEE_DEP': 'hidden field', 'INSEE_REG': 'hidden field', 'POPULATION': 'hidden field', 'SURFACE_HA': 'hidden field', 'DATE_CREAT': 'hidden field', 'DATE_MAJ': 'hidden field', 'DATE_APP': 'hidden field', 'DATE_CONF': 'hidden field', 'CODE_POST': 'hidden field', 'NOM': 'hidden field', 'CL_ARROND': 'hidden field', 'CL_COLLTER': 'hidden field', 'CL_DEPART': 'hidden field', 'CL_REGION': 'hidden field', 'CAPITALE': 'hidden field', 'DATE_RCT': 'hidden field', 'RECENSEUR': 'hidden field', 'SIREN_EPCI': 'hidden field', 'ID_CH_LIEU': 'hidden field', 'ID_AUT_ADM': 'hidden field', 'CODE_SIREN': 'hidden field', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_Nomdescommunes_199.on('precompose', function(evt) {
