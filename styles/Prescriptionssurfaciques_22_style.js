var size = 0;
var placement = 'point';
function categories_Prescriptionssurfaciques_22(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Espace boisé classé':
...
var style_Prescriptionssurfaciques_22 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Prescriptionssurfaciques_22(feature, value, size, resolution, labelText,
