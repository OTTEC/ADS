var size = 0;
var placement = 'point';
function categories_Prescriptionssurfaciques_30(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Périmètre de protection lié à la présence d\'axe de ruissellement':
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case 'Périmètre de sécurité lié à la présence d\'un indice de cavités souterraines':
                    return [ new ol.style.Style({
...
var style_Prescriptionssurfaciques_30 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Prescriptionssurfaciques_30(feature, value, size, resolution, labelText,
