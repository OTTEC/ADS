var size = 0;
var placement = 'point';
function categories_Secteurs_96(feature, value, size, resolution, labelText,
...
var style_Secteurs_96 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Secteurs_96(feature, value, size, resolution, labelText,
