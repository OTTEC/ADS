var size = 0;
var placement = 'point';
function categories_Secteurs_43(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'ZC':
...
var style_Secteurs_43 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Secteurs_43(feature, value, size, resolution, labelText,
