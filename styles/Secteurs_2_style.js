...
function categories_Secteurs_2(feature, value, size, resolution, labelText,
        ...
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: [2.6599999999999997,1.3299999999999998], lineCap: 'butt', lineJoin: 'miter', width: 1.3299999999999998}),fill: new ol.style.Fill({color: 'rgba(255,127,0,0.7019607843137254)'}),
