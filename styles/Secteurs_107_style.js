var size = 0;
var placement = 'point';
function categories_Secteurs_107(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Zone constru':
...
var style_Secteurs_107 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Secteurs_107(feature, value, size, resolution, labelText,
