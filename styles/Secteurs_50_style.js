var size = 0;
var placement = 'point';
function categories_Secteurs_50(feature, value, size, resolution, labelText,
...
var style_Secteurs_50 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Secteurs_50(feature, value, size, resolution, labelText,
