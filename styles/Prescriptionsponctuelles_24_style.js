var size = 0;
var placement = 'point';
function categories_Prescriptionsponctuelles_24(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Bâtiment agricole pouvant changer de destination':
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case 'Bâtiment intéressant à protéger':
                    return [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 10.0 + size, points: 5,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case 'Bâtiment remarquable à protéger':
                    return [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 10.0 + size, points: 5,
            radius2: 5.0, displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(227,26,28,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(255,1,1,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
...
var style_Prescriptionsponctuelles_24 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Prescriptionsponctuelles_24(feature, value, size, resolution, labelText,
