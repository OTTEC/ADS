var size = 0;
var placement = 'point';
function categories_Prescriptionslinaires_110(feature, value, size, resolution, labelText,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case 'Haies paysagères remarquable':
                    return [ new ol.style.Style({
...
var style_Prescriptionslinaires_110 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Prescriptionslinaires_110(feature, value, size, resolution, labelText,
