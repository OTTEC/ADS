...
var measureControl = (function (Control) {
    ...
    map.on('pointermove', function(evt) {
        ...
        if (measuring) {
            /** @type {string} */
            var helpMsg = 'Cliquez une fois pour continuer, double-cliquez pour terminer';
            if (sketch) {
 ...
 * @type {string}
 */
var continueLineMsg = 'Cliquez pour continuer la ligne';
 ...
 * @type {string}
 */
var continuePolygonMsg = "Cliquez une fois pour continuer, double-cliquez pour terminer";
