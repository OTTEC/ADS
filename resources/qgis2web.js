...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [25881.6517505, 6291423.157331, 301053.8711375, 6484601.121985], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([57632.292449, 6313712.922483, 269303.230439, 6462311.356832], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">OTTEC - Autorisations du Droit des Sols</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1873 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '💡 Prise en main de l\'application<br /><br />Pour masquer la légende, cliquez sur l\'icône en forme de chevrons au-dessus de celle-ci. Pour visualiser à nouveau la légende, cliquez sur l\'icône représentant un carré de couleur bleue. Cochez ou décochez ensuite l\'affichage des éléments que vous souhaitez ajouter ou retirer à la carte. Vous pouvez également cliquer directement sur les éléments à l\'intérieur de la carte pour afficher une info-bulle descriptive.<br /><br />Certains éléments ne sont visibles qu\'à partir d\'un certain niveau de zoom. Il est aussi déconseillé d\'activer un trop grand nombre d\'éléments en même temps.<br /><br />⚠️ Avertissement relatif à l\'utilisation de la cartographie<br /><br />Les données diffusées sur cette application cartographique sont mises à disposition par le PETR à titre informatif et pour consultation libre uniquement. Elles n’ont aucune valeur réglementaire et ne sauraient en aucun cas se substituer aux documents officiels ou aux données opposables en droit.<br /><br />Le PETR décline toute responsabilité quant à l\'utilisation qui pourrait être faite de ces données. Toute exploitation, interprétation ou décision prise sur la base des informations présentées relève de la seule responsabilité de l\'utilisateur. En aucun cas le PETR ne pourra être tenu pour responsable des conséquences d’une utilisation inappropriée ou erronée de ces données.<br /><br />Le PETR s’efforce de proposer les données les plus récentes et exactes possibles, en tenant compte de l’état actuel de la connaissance du territoire, ainsi que des possibilités d’obtention, de traitement et de diffusion des données. La cartographie est mise à jour aussi régulièrement que possible, sans garantie d’exhaustivité ni d\'actualisation immédiate.<br /><br />Application créée dans le cadre de l\'Observatoire Territorial de la Transition Ecologique et Climatique.<br /><br />Pôle d\'Equilibre Territorial et Rural du Pays de Bray (2025).';
            }
...
var measureControl = (function (Control) {
    ...
    var measurementOption = [
        { value: "LineString", description: "Longueur" },
        { value: "Polygon", description: "Surface" }
        ];
 ...
 * @type {string}
 */
var continueLineMsg = '1 clic pour continuer, 2 clics pour terminer';
 ...
 * @type {string}
 */
var continuePolygonMsg = "1 clic pour continuer, 2 clics pour terminer";
